	$(document).ready(function() {
		...
		$('#checkout-step-billing').append(function(i, re) {
			//var insert_string = '<br /><p><table id="autocomplete_melissadata_fielded" border="0px;"><tbody style="font-weight: bold; font-size: 140%;"><b>Melissa Data Fielded Autocompletion Support:</b></tbody><tr width="'+(3*MAX_LENGTH_GEE_FIELDED_BLOCK)+'px"><td><br /></td></tr><tr><td width="'+MAX_LENGTH_GEE_FIELDED_BLOCK+'px"><input type="text" value="" placeholder="1. Step: Type Country Name" title="Start typing a country name to get Suggestions" id="CountrySuggestions" style="width: '+MAX_LENGTH_GEE_FIELDED_BLOCK+'px;" /><span id="showCountryResults" style="width:150px;height:150px;line-height:3em;overflow:auto;padding:5px;"></span></td><td width="'+MAX_LENGTH_GEE_FIELDED_BLOCK+'px"><input type="text" value="" placeholder="2. Step: Type Postal Code" title="Start typing a Postal code to get Suggestions from within that Country" id="PostalCodeSuggestions" style="width: '+MAX_LENGTH_GEE_FIELDED_BLOCK+'px;" /><span id="showPostalCodeResults"></span></td><td width="'+MAX_LENGTH_GEE_FIELDED_BLOCK+'px"><input type="text" value="" placeholder="3. Step: Type Street Name" title="Start typing a street name to get suggestions for them within that Postal code range in that country" id="StreetSuggestions" style="width: '+MAX_LENGTH_GEE_FIELDED_BLOCK+'px;" /><span id="showStreetResults"></span></td></tr></table></p><br /><br /><br /><br /><p><table id="autocomplete_melissadata_singlerow" border="0px;"><tbody style="font-weight: bold; font-size: 140%;"><b>Melissa Data Single Row Autocompletion Support:</b></tbody><tr width=""><td><br /></td></tr><tr><td width="'+MAX_LENGTH_GEE_FIELDED_BLOCK+'px"><input type="text" value="" placeholder="1. Step: Type Country Name" title="Start typing a country name to get Suggestions" id="CountrySuggestionsSingleRow" style="width: '+MAX_LENGTH_GEE_FIELDED_BLOCK+'px;" /><span id="showCountryResultsSingleRow"></span></td><td width="'+MAX_LENGTH_GEE_SINGLELINE_BLOCK+'px"><input type="text" value="" placeholder="2. Step: Type Postal Code & Address" title="Start typing a Postal code & Address to get Suggestions from within that Country" id="AddressSuggestionsSingleRow" style="width: '+MAX_LENGTH_GEE_SINGLELINE_BLOCK+'px;" /><span id="showAddressResultsSingleRow" style="width: '+MAX_LENGTH_GEE_SINGLELINE_BLOCK+'px;"></span></td></tr></table></p><br /><br /><span id="gawsresults_top"></span><br />';
			...
			/*				
						$.each(ArrResultCodes, function( index, value ) {
							...
							if ( value.match(/AE01/ig) != null ){ 
								image_postalcode_notok = '<img alt="Nicht korrekt" title="Schlechte Ergebnisqualität" src="data:image/png;base64,'+red_notok+'"/>';
							}
							if ( value.match(/AE02/ig) != null ){ 
								image_street_notok = '<img alt="Nicht korrekt" title="Schlechte Ergebnisqualität" src="data:image/png;base64,'+red_notok+'"/>';
							}
							if ( value.match(/AV13/ig) != null ){ 
								image_street_notok = '<img alt="Grüner Haken" title="Sehr gute Ergebnisse / Very good Quality" src="data:image/png;base64,'+green_ok+'"/>';
							}
