...
n=o.length-1;n>=0;n--)r=t.data(o[n],this.widgetFullName),r&&r!==this&&!r.options.disabled&&l.push([t.isFunction(r.options.items)?r.options.items.call(r.element):t(r.options.items,r.element).not(".ui-sortable-helper").not(".ui-sortable-placeholder"),r]);for(l.push([t.isFunction(this.options.items)?this.options.items.call(this.element,null,{options:this.options,item:this.currentItem}):t(this.options.items,this.element).not(".ui-sortable-helper").not(".ui-sortable-placeholder"),this]),s=l.length-1;s>=0;s--)l[s][0].each(i);return t(a)},_removeCurrentsFromItems:function(){var e=this.currentItem.find(":data("+this.widgetName+"-item)");this.items=t.grep(this.items,function(t){for(var i=0;e.length>i;i++)if(e[i]===t.item[0])return!1;return!0})},_refreshItems:function(e){this.items=[],this.containers=[this];var i,s,n,o,r,a,l,h,u=this.items,c=[[t.isFunction(this.options.items)?this.options.items.call(this.element[0],e,{item:this.currentItem}):t(this.options.items,this.element),this]],d=this._connectWith();if(d&&this.ready)for(i=d.length-1;i>=0;i--)for(n=t(d[i],this.document[0]),s=n.length-1;s>=0;s--)o=t.data(n[s],this.widgetFullName),o&&o!==this&&!o.options.disabled&&(c.push([t.isFunction(o.options.items)?o.options.items.call(o.element[0],e,{item:this.currentItem}):t(o.options.items,o.element),o]),this.containers.push(o));for(i=c.length-1;i>=0;i--)for(r=c[i][1],a=c[i][0],s=0,h=a.length;h>s;s++)l=t(a[s]),l.data(this.widgetName+"-item",r),u.push({item:l,instance:r,width:0,height:0,left:0,top:0})},refreshPositions:function(e){this.floating=this.items.length?"x"===this.options.axis||this._isFloating(this.items[0].item):!1,this.offsetParent&&this.helper&&(this.offset.parent=this._getParentOffset());var i,s,n,o;for(i=this.items.length-1;i>=0;i--)s=this.items[i],s.instance!==this.currentContainer&&this.currentContainer&&s.item[0]!==this.currentItem[0]||(n=this.options.toleranceElement?t(this.options.toleranceElement,s.item):s.item,e||(s.width=n.outerWidth(),s.height=n.outerHeight()),o=n.offset(),s.left=o.left,s.top=o.top);if(this.options.custom&&this.options.custom.refreshContainers)this.options.custom.refreshContainers.call(this);else for(i=this.containers.length-1;i>=0;i--)o=this.containers[i].element.offset(),this.containers[i].containerCache.left=o.left,this.containers[i].containerCache.top=o.top,this.containers[i].containerCache.width=this.containers[i].element.outerWidth(),this.containers[i].containerCache.height=this.containers[i].element.outerHeight();return this},_createPlaceholder:function(e){e=e||this;var i,s=e.options;s.placeholder&&s.placeholder.constructor!==String||(i=s.placeholder,s.placeholder={element:function(){var s=e.currentItem[0].nodeName.toLowerCase(),n=t("<"+s+">",e.document[0]).addClass(i||e.currentItem[0].className+" ui-sortable-placeholder").removeClass("ui-sortable-helper");return"tbody"===s?e._createTrPlaceholder(e.currentItem.find("tr").eq(0),t("<tr>",e.document[0]).appendTo(n)):"tr"===s?e._createTrPlaceholder(e.currentItem,n):"img"===s&&n.attr("src",e.currentItem.attr("src")),i||n.css("visibility","hidden"),n},update:function(t,n){(!i||s.forcePlaceholderSize)&&(n.height()||n.height(e.currentItem.innerHeight()-parseInt(e.currentItem.css("paddingTop")||0,10)-parseInt(e.currentItem.css("paddingBottom")||0,10)),n.width()||n.width(e.currentItem.innerWidth()-parseInt(e.currentItem.css("paddingLeft")||0,10)-parseInt(e.currentItem.css("paddingRight")||0,10)))}}),e.placeholder=t(s.placeholder.element.call(e.element,e.currentItem)),e.currentItem.after(e.placeholder),s.placeholder.update(e,e.placeholder)},_createTrPlaceholder:function(e,i){var s=this;e.children().each(function(){t("<td>&#160;</td>",s.document[0]).attr("colspan",t(this).attr("colspan")||1).appendTo(i)})},_contactContainers:function(e){var i,s,n,o,r,a,l,h,u,c,d=null,p=null;for(i=this.containers.length-1;i>=0;i--)if(!t.contains(this.currentItem[0],this.containers[i].element[0]))if(this._intersectsWith(this.containers[i].containerCache)){if(d&&t.contains(this.containers[i].element[0],d.element[0]))continue;d=this.containers[i],p=i}else this.containers[i].containerCache.over&&(this.containers[i]._trigger("out",e,this._uiHash(this)),this.containers[i].containerCache.over=0);if(d)if(1===this.containers.length)this.containers[p].containerCache.over||(this.containers[p]._trigger("over",e,this._uiHash(this)),this.containers[p].containerCache.over=1);else{for(n=1e4,o=null,u=d.floating||this._isFloating(this.currentItem),r=u?"left":"top",a=u?"width":"height",c=u?"clientX":"clientY",s=this.items.length-1;s>=0;s--)t.contains(this.containers[p].element[0],this.items[s].item[0])&&this.items[s].item[0]!==this.currentItem[0]&&(l=this.items[s].item.offset()[r],h=!1,e[c]-l>this.items[s][a]/2&&(h=!0),n>Math.abs(e[c]-l)&&(n=Math.abs(e[c]-l),o=this.items[s],this.direction=h?"up":"down"));if(!o&&!this.options.dropOnEmpty)return;if(this.currentContainer===this.containers[p])return void(this.currentContainer.containerCache.over||(this.containers[p]._trigger("over",e,this._uiHash()),this.currentContainer.containerCache.over=1));o?this._rearrange(e,o,null,!0):this._rearrange(e,null,this.containers[p].element,!0),this._trigger("change",e,this._uiHash()),this.containers[p]._trigger("change",e,this._uiHash(this)),this.currentContainer=this.containers[p],this.options.placeholder.update(this.currentContainer,this.placeholder),this.containers[p]._trigger("over",e,this._uiHash(this)),this.containers[p].containerCache.over=1}},_createHelper:function(e){var i=this.options,s=t.isFunction(i.helper)?t(i.helper.apply(this.element[0],[e,this.currentItem])):"clone"===i.helper?this.currentItem.clone():this.currentItem;return s.parents("body").length||t("parent"!==i.appendTo?i.appendTo:this.currentItem[0].parentNode)[0].appendChild(s[0]),s[0]===this.currentItem[0]&&(this._storedCSS={width:this.currentItem[0].style.width,height:this.currentItem[0].style.height,position:this.currentItem.css("position"),top:this.currentItem.css("top"),left:this.currentItem.css("left")}),(!s[0].style.width||i.forceHelperSize)&&s.width(this.currentItem.width()),(!s[0].style.height||i.forceHelperSize)&&s.height(this.currentItem.height()),s},_adjustOffsetFromHelper:function(e){"string"==typeof e&&(e=e.split(" ")),t.isArray(e)&&(e={left:+e[0],top:+e[1]||0}),"left"in e&&(this.offset.click.left=e.left+this.margins.left),"right"in e&&(this.offset.click.left=this.helperProportions.width-e.right+this.margins.left),"top"in e&&(this.offset.click.top=e.top+this.margins.top),"bottom"in e&&(this.offset.click.top=this.helperProportions.height-e.bottom+this.margins.top)},_getParentOffset:function(){this.offsetParent=this.helper.offsetParent();var e=this.offsetParent.offset();return"absolute"===this.cssPosition&&this.scrollParent[0]!==this.document[0]&&t.contains(this.scrollParent[0],this.offsetParent[0])&&(e.left+=this.scrollParent.scrollLeft(),e.top+=this.scrollParent.scrollTop()),(this.offsetParent[0]===this.document[0].body||this.offsetParent[0].tagName&&"html"===this.offsetParent[0].tagName.toLowerCase()&&t.ui.ie)&&(e={top:0,left:0}),{top:e.top+(parseInt(this.offsetParent.css("borderTopWidth"),10)||0),left:e.left+(parseInt(this.offsetParent.css("borderLeftWidth"),10)||0)}},_getRelativeOffset:function(){if("relative"===this.cssPosition){var t=this.currentItem.position();return{top:t.top-(parseInt(this.helper.css("top"),10)||0)+this.scrollParent.scrollTop(),left:t.left-(parseInt(this.helper.css("left"),10)||0)+this.scrollParent.scrollLeft()}}return{top:0,left:0}},_cacheMargins:function(){this.margins={left:parseInt(this.currentItem.css("marginLeft"),10)||0,top:parseInt(this.currentItem.css("marginTop"),10)||0}},_cacheHelperProportions:function(){this.helperProportions={width:this.helper.outerWidth(),height:this.helper.outerHeight()}},_setContainment:function(){var e,i,s,n=this.options;"parent"===n.containment&&(n.containment=this.helper[0].parentNode),("document"===n.containment||"window"===n.containment)&&(this.containment=[0-this.offset.relative.left-this.offset.parent.left,0-this.offset.relative.top-this.offset.parent.top,"document"===n.containment?this.document.width():this.window.width()-this.helperProportions.width-this.margins.left,("document"===n.containment?this.document.width():this.window.height()||this.document[0].body.parentNode.scrollHeight)-this.helperProportions.height-this.margins.top]),/^(document|window|parent)$/.test(n.containment)||(e=t(n.containment)[0],i=t(n.containment).offset(),s="hidden"!==t(e).css("overflow"),this.containment=[i.left+(parseInt(t(e).css("borderLeftWidth"),10)||0)+(parseInt(t(e).css("paddingLeft"),10)||0)-this.margins.left,i.top+(parseInt(t(e).css("borderTopWidth"),10)||0)+(parseInt(t(e).css("paddingTop"),10)||0)-this.margins.top,i.left+(s?Math.max(e.scrollWidth,e.offsetWidth):e.offsetWidth)-(parseInt(t(e).css("borderLeftWidth"),10)||0)-(parseInt(t(e).css("paddingRight"),10)||0)-this.helperProportions.width-this.margins.left,i.top+(s?Math.max(e.scrollHeight,e.offsetHeight):e.offsetHeight)-(parseInt(t(e).css("borderTopWidth"),10)||0)-(parseInt(t(e).css("paddingBottom"),10)||0)-this.helperProportions.height-this.margins.top])},_convertPositionTo:function(e,i){i||(i=this.position);var s="absolute"===e?1:-1,n="absolute"!==this.cssPosition||this.scrollParent[0]!==this.document[0]&&t.contains(this.scrollParent[0],this.offsetParent[0])?this.scrollParent:this.offsetParent,o=/(html|body)/i.test(n[0].tagName);return{top:i.top+this.offset.relative.top*s+this.offset.parent.top*s-("fixed"===this.cssPosition?-this.scrollParent.scrollTop():o?0:n.scrollTop())*s,left:i.left+this.offset.relative.left*s+this.offset.parent.left*s-("fixed"===this.cssPosition?-this.scrollParent.scrollLeft():o?0:n.scrollLeft())*s}},_generatePosition:function(e){var i,s,n=this.options,o=e.pageX,r=e.pageY,a="absolute"!==this.cssPosition||this.scrollParent[0]!==this.document[0]&&t.contains(this.scrollParent[0],this.offsetParent[0])?this.scrollParent:this.offsetParent,l=/(html|body)/i.test(a[0].tagName);return"relative"!==this.cssPosition||this.scrollParent[0]!==this.document[0]&&this.scrollParent[0]!==this.offsetParent[0]||(this.offset.relative=this._getRelativeOffset()),this.originalPosition&&(this.containment&&(e.pageX-this.offset.click.left<this.containment[0]&&(o=this.containment[0]+this.offset.click.left),e.pageY-this.offset.click.top<this.containment[1]&&(r=this.containment[1]+this.offset.click.top),e.pageX-this.offset.click.left>this.containment[2]&&(o=this.containment[2]+this.offset.click.left),e.pageY-this.offset.click.top>this.containment[3]&&(r=this.containment[3]+this.offset.click.top)),n.grid&&(i=this.originalPageY+Math.round((r-this.originalPageY)/n.grid[1])*n.grid[1],r=this.containment?i-this.offset.click.top>=this.containment[1]&&i-this.offset.click.top<=this.containment[3]?i:i-this.offset.click.top>=this.containment[1]?i-n.grid[1]:i+n.grid[1]:i,s=this.originalPageX+Math.round((o-this.originalPageX)/n.grid[0])*n.grid[0],o=this.containment?s-this.offset.click.left>=this.containment[0]&&s-this.offset.click.left<=this.containment[2]?s:s-this.offset.click.left>=this.containment[0]?s-n.grid[0]:s+n.grid[0]:s)),{top:r-this.offset.click.top-this.offset.relative.top-this.offset.parent.top+("fixed"===this.cssPosition?-this.scrollParent.scrollTop():l?0:a.scrollTop()),left:o-this.offset.click.left-this.offset.relative.left-this.offset.parent.left+("fixed"===this.cssPosition?-this.scrollParent.scrollLeft():l?0:a.scrollLeft())}},_rearrange:function(t,e,i,s){i?i[0].appendChild(this.placeholder[0]):e.item[0].parentNode.insertBefore(this.placeholder[0],"down"===this.direction?e.item[0]:e.item[0].nextSibling),this.counter=this.counter?++this.counter:1;var n=this.counter;this._delay(function(){n===this.counter&&this.refreshPositions(!s)})},_clear:function(t,e){function i(t,e,i){return function(s){i._trigger(t,s,e._uiHash(e))}}this.reverting=!1;var s,n=[];if(!this._noFinalSort&&this.currentItem.parent().length&&this.placeholder.before(this.currentItem),this._noFinalSort=null,this.helper[0]===this.currentItem[0]){for(s in this._storedCSS)("auto"===this._storedCSS[s]||"static"===this._storedCSS[s])&&(this._storedCSS[s]="");this.currentItem.css(this._storedCSS).removeClass("ui-sortable-helper")}else this.currentItem.show();for(this.fromOutside&&!e&&n.push(function(t){this._trigger("receive",t,this._uiHash(this.fromOutside))}),!this.fromOutside&&this.domPosition.prev===this.currentItem.prev().not(".ui-sortable-helper")[0]&&this.domPosition.parent===this.currentItem.parent()[0]||e||n.push(function(t){this._trigger("update",t,this._uiHash())}),this!==this.currentContainer&&(e||(n.push(function(t){this._trigger("remove",t,this._uiHash())}),n.push(function(t){return function(e){t._trigger("receive",e,this._uiHash(this))}}.call(this,this.currentContainer)),n.push(function(t){return function(e){t._trigger("update",e,this._uiHash(this))}}.call(this,this.currentContainer)))),s=this.containers.length-1;s>=0;s--)e||n.push(i("deactivate",this,this.containers[s])),this.containers[s].containerCache.over&&(n.push(i("out",this,this.containers[s])),this.containers[s].containerCache.over=0);if(this.storedCursor&&(this.document.find("body").css("cursor",this.storedCursor),this.storedStylesheet.remove()),this._storedOpacity&&this.helper.css("opacity",this._storedOpacity),this._storedZIndex&&this.helper.css("zIndex","auto"===this._storedZIndex?"":this._storedZIndex),this.dragging=!1,e||this._trigger("beforeStop",t,this._uiHash()),this.placeholder[0].parentNode.removeChild(this.placeholder[0]),this.cancelHelperRemoval||(this.helper[0]!==this.currentItem[0]&&this.helper.remove(),this.helper=null),!e){for(s=0;n.length>s;s++)n[s].call(this,t);this._trigger("stop",t,this._uiHash())}return this.fromOutside=!1,!this.cancelHelperRemoval},_trigger:function(){t.Widget.prototype._trigger.apply(this,arguments)===!1&&this.cancel()},_uiHash:function(e){var i=e||this;return{helper:i.helper,placeholder:i.placeholder||t([]),position:i.position,originalPosition:i.originalPosition,offset:i.positionAbs,item:i.currentItem,sender:e?e.element:null}}}),t.widget("ui.spinner",{version:"1.11.4",defaultElement:"<input>",widgetEventPrefix:"spin",options:{culture:null,icons:{down:"ui-icon-triangle-1-s",up:"ui-icon-triangle-1-n"},incremental:!0,max:null,min:null,numberFormat:null,page:10,step:1,change:null,spin:null,start:null,stop:null},_create:function(){this._setOption("max",this.options.max),this._setOption("min",this.options.min),this._setOption("step",this.options.step),""!==this.value()&&this._value(this.element.val(),!0),this._draw(),this._on(this._events),this._refresh(),this._on(this.window,{beforeunload:function(){this.element.removeAttr("autocomplete")}})},_getCreateOptions:function(){var e={},i=this.element;return t.each(["min","max","step"],function(t,s){var n=i.attr(s);void 0!==n&&n.length&&(e[s]=n)}),e},_events:{keydown:function(t){this._start(t)&&this._keydown(t)&&t.preventDefault()},keyup:"_stop",focus:function(){this.previous=this.element.val()},blur:function(t){return this.cancelBlur?void delete this.cancelBlur:(this._stop(),this._refresh(),void(this.previous!==this.element.val()&&this._trigger("change",t)))},mousewheel:function(t,e){if(e){if(!this.spinning&&!this._start(t))return!1;this._spin((e>0?1:-1)*this.options.step,t),clearTimeout(this.mousewheelTimer),this.mousewheelTimer=this._delay(function(){this.spinning&&this._stop(t)},100),t.preventDefault()}},"mousedown .ui-spinner-button":function(e){function i(){var t=this.element[0]===this.document[0].activeElement;t||(this.element.focus(),this.previous=s,this._delay(function(){this.previous=s}))}var s;s=this.element[0]===this.document[0].activeElement?this.previous:this.element.val(),e.preventDefault(),i.call(this),this.cancelBlur=!0,this._delay(function(){delete this.cancelBlur,i.call(this)}),this._start(e)!==!1&&this._repeat(null,t(e.currentTarget).hasClass("ui-spinner-up")?1:-1,e)},"mouseup .ui-spinner-button":"_stop","mouseenter .ui-spinner-button":function(e){return t(e.currentTarget).hasClass("ui-state-active")?this._start(e)===!1?!1:void this._repeat(null,t(e.currentTarget).hasClass("ui-spinner-up")?1:-1,e):void 0},"mouseleave .ui-spinner-button":"_stop"},_draw:function(){var t=this.uiSpinner=this.element.addClass("ui-spinner-input").attr("autocomplete","off").wrap(this._uiSpinnerHtml()).parent().append(this._buttonHtml());this.element.attr("role","spinbutton"),this.buttons=t.find(".ui-spinner-button").attr("tabIndex",-1).button().removeClass("ui-corner-all"),this.buttons.height()>Math.ceil(.5*t.height())&&t.height()>0&&t.height(t.height()),this.options.disabled&&this.disable()},_keydown:function(e){var i=this.options,s=t.ui.keyCode;switch(e.keyCode){case s.UP:return this._repeat(null,1,e),!0;case s.DOWN:return this._repeat(null,-1,e),!0;case s.PAGE_UP:return this._repeat(null,i.page,e),!0;case s.PAGE_DOWN:return this._repeat(null,-i.page,e),!0}return!1},_uiSpinnerHtml:function(){return"<span class='ui-spinner ui-widget ui-widget-content ui-corner-all'></span>"},_buttonHtml:function(){return"<a class='ui-spinner-button ui-spinner-up ui-corner-tr'><span class='ui-icon "+this.options.icons.up+"'>&#9650;</span></a><a class='ui-spinner-button ui-spinner-down ui-corner-br'><span class='ui-icon "+this.options.icons.down+"'>&#9660;</span></a>"},_start:function(t){return this.spinning||this._trigger("start",t)!==!1?(this.counter||(this.counter=1),this.spinning=!0,!0):!1},_repeat:function(t,e,i){t=t||500,clearTimeout(this.timer),this.timer=this._delay(function(){this._repeat(40,e,i)},t),this._spin(e*this.options.step,i)},_spin:function(t,e){var i=this.value()||0;this.counter||(this.counter=1),i=this._adjustValue(i+t*this._increment(this.counter)),this.spinning&&this._trigger("spin",e,{value:i})===!1||(this._value(i),this.counter++)},_increment:function(e){var i=this.options.incremental;return i?t.isFunction(i)?i(e):Math.floor(e*e*e/5e4-e*e/500+17*e/200+1):1},_precision:function(){var t=this._precisionOf(this.options.step);return null!==this.options.min&&(t=Math.max(t,this._precisionOf(this.options.min))),t},_precisionOf:function(t){var e=""+t,i=e.indexOf(".");return-1===i?0:e.length-i-1},_adjustValue:function(t){var e,i,s=this.options;return e=null!==s.min?s.min:0,i=t-e,i=Math.round(i/s.step)*s.step,t=e+i,t=parseFloat(t.toFixed(this._precision())),null!==s.max&&t>s.max?s.max:null!==s.min&&s.min>t?s.min:t},_stop:function(t){this.spinning&&(clearTimeout(this.timer),clearTimeout(this.mousewheelTimer),this.counter=0,this.spinning=!1,this._trigger("stop",t))},_setOption:function(t,e){if("culture"===t||"numberFormat"===t){var i=this._parse(this.element.val());return this.options[t]=e,void this.element.val(this._format(i))}("max"===t||"min"===t||"step"===t)&&"string"==typeof e&&(e=this._parse(e)),"icons"===t&&(this.buttons.first().find(".ui-icon").removeClass(this.options.icons.up).addClass(e.up),this.buttons.last().find(".ui-icon").removeClass(this.options.icons.down).addClass(e.down)),this._super(t,e),"disabled"===t&&(this.widget().toggleClass("ui-state-disabled",!!e),this.element.prop("disabled",!!e),this.buttons.button(e?"disable":"enable"))},_setOptions:l(function(t){this._super(t)}),_parse:function(t){return"string"==typeof t&&""!==t&&(t=window.Globalize&&this.options.numberFormat?Globalize.parseFloat(t,10,this.options.culture):+t),""===t||isNaN(t)?null:t},_format:function(t){return""===t?"":window.Globalize&&this.options.numberFormat?Globalize.format(t,this.options.numberFormat,this.options.culture):t},_refresh:function(){this.element.attr({"aria-valuemin":this.options.min,"aria-valuemax":this.options.max,"aria-valuenow":this._parse(this.element.val())})},isValid:function(){var t=this.value();return null===t?!1:t===this._adjustValue(t)},_value:function(t,e){var i;""!==t&&(i=this._parse(t),null!==i&&(e||(i=this._adjustValue(i)),t=this._format(i))),this.element.val(t),this._refresh()},_destroy:function(){this.element.removeClass("ui-spinner-input").prop("disabled",!1).removeAttr("autocomplete").removeAttr("role").removeAttr("aria-valuemin").removeAttr("aria-valuemax").removeAttr("aria-valuenow"),this.uiSpinner.replaceWith(this.element)},stepUp:l(function(t){this._stepUp(t)}),_stepUp:function(t){this._start()&&(this._spin((t||1)*this.options.step),this._stop())},stepDown:l(function(t){this._stepDown(t)}),_stepDown:function(t){this._start()&&(this._spin((t||1)*-this.options.step),this._stop())},pageUp:l(function(t){this._stepUp((t||1)*this.options.page)}),pageDown:l(function(t){this._stepDown((t||1)*this.options.page)}),value:function(t){return arguments.length?void l(this._value).call(this,t):this._parse(this.element.val())},widget:function(){return this.uiSpinner}}),t.widget("ui.tabs",{version:"1.11.4",delay:300,options:{active:null,collapsible:!1,event:"click",heightStyle:"content",hide:null,show:null,activate:null,beforeActivate:null,beforeLoad:null,load:null},_isLocal:function(){var t=/#.*$/;return function(e){var i,s;e=e.cloneNode(!1),i=e.href.replace(t,""),s=location.href.replace(t,"");try{i=decodeURIComponent(i)}catch(n){}try{s=decodeURIComponent(s)}catch(n){}return e.hash.length>1&&i===s}}(),_create:function(){var e=this,i=this.options;this.running=!1,this.element.addClass("ui-tabs ui-widget ui-widget-content ui-corner-all").toggleClass("ui-tabs-collapsible",i.collapsible),this._processTabs(),i.active=this._initialActive(),t.isArray(i.disabled)&&(i.disabled=t.unique(i.disabled.concat(t.map(this.tabs.filter(".ui-state-disabled"),function(t){return e.tabs.index(t)}))).sort()),this.active=this.options.active!==!1&&this.anchors.length?this._findActive(i.active):t(),this._refresh(),this.active.length&&this.load(i.active)},_initialActive:function(){var e=this.options.active,i=this.options.collapsible,s=location.hash.substring(1);return null===e&&(s&&this.tabs.each(function(i,n){return t(n).attr("aria-controls")===s?(e=i,!1):void 0}),null===e&&(e=this.tabs.index(this.tabs.filter(".ui-tabs-active"))),(null===e||-1===e)&&(e=this.tabs.length?0:!1)),e!==!1&&(e=this.tabs.index(this.tabs.eq(e)),-1===e&&(e=i?!1:0)),!i&&e===!1&&this.anchors.length&&(e=0),e},_getCreateEventData:function(){return{tab:this.active,panel:this.active.length?this._getPanelForTab(this.active):t()}},_tabKeydown:function(e){var i=t(this.document[0].activeElement).closest("li"),s=this.tabs.index(i),n=!0;if(!this._handlePageNav(e)){switch(e.keyCode){case t.ui.keyCode.RIGHT:case t.ui.keyCode.DOWN:s++;break;case t.ui.keyCode.UP:case t.ui.keyCode.LEFT:n=!1,s--;break;case t.ui.keyCode.END:s=this.anchors.length-1;break;case t.ui.keyCode.HOME:s=0;break;case t.ui.keyCode.SPACE:return e.preventDefault(),clearTimeout(this.activating),void this._activate(s);case t.ui.keyCode.ENTER:return e.preventDefault(),clearTimeout(this.activating),void this._activate(s===this.options.active?!1:s);default:return}e.preventDefault(),clearTimeout(this.activating),s=this._focusNextTab(s,n),e.ctrlKey||e.metaKey||(i.attr("aria-selected","false"),this.tabs.eq(s).attr("aria-selected","true"),this.activating=this._delay(function(){this.option("active",s)},this.delay))}},_panelKeydown:function(e){this._handlePageNav(e)||e.ctrlKey&&e.keyCode===t.ui.keyCode.UP&&(e.preventDefault(),this.active.focus())},_handlePageNav:function(e){return e.altKey&&e.keyCode===t.ui.keyCode.PAGE_UP?(this._activate(this._focusNextTab(this.options.active-1,!1)),!0):e.altKey&&e.keyCode===t.ui.keyCode.PAGE_DOWN?(this._activate(this._focusNextTab(this.options.active+1,!0)),!0):void 0},_findNextTab:function(e,i){function s(){return e>n&&(e=0),0>e&&(e=n),e}for(var n=this.tabs.length-1;-1!==t.inArray(s(),this.options.disabled);)e=i?e+1:e-1;return e},_focusNextTab:function(t,e){return t=this._findNextTab(t,e),this.tabs.eq(t).focus(),t},_setOption:function(t,e){return"active"===t?void this._activate(e):"disabled"===t?void this._setupDisabled(e):(this._super(t,e),"collapsible"===t&&(this.element.toggleClass("ui-tabs-collapsible",e),e||this.options.active!==!1||this._activate(0)),"event"===t&&this._setupEvents(e),void("heightStyle"===t&&this._setupHeightStyle(e)))},_sanitizeSelector:function(t){return t?t.replace(/[!"$%&'()*+,.\/:;<=>?@\[\]\^`{|}~]/g,"\\$&"):""},refresh:function(){var e=this.options,i=this.tablist.children(":has(a[href])");e.disabled=t.map(i.filter(".ui-state-disabled"),function(t){return i.index(t)}),this._processTabs(),e.active!==!1&&this.anchors.length?this.active.length&&!t.contains(this.tablist[0],this.active[0])?this.tabs.length===e.disabled.length?(e.active=!1,this.active=t()):this._activate(this._findNextTab(Math.max(0,e.active-1),!1)):e.active=this.tabs.index(this.active):(e.active=!1,this.active=t()),this._refresh()},_refresh:function(){this._setupDisabled(this.options.disabled),this._setupEvents(this.options.event),this._setupHeightStyle(this.options.heightStyle),this.tabs.not(this.active).attr({"aria-selected":"false","aria-expanded":"false",tabIndex:-1}),this.panels.not(this._getPanelForTab(this.active)).hide().attr({"aria-hidden":"true"}),this.active.length?(this.active.addClass("ui-tabs-active ui-state-active").attr({"aria-selected":"true","aria-expanded":"true",tabIndex:0}),this._getPanelForTab(this.active).show().attr({"aria-hidden":"false"})):this.tabs.eq(0).attr("tabIndex",0)},_processTabs:function(){var e=this,i=this.tabs,s=this.anchors,n=this.panels;this.tablist=this._getList().addClass("ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all").attr("role","tablist").delegate("> li","mousedown"+this.eventNamespace,function(e){t(this).is(".ui-state-disabled")&&e.preventDefault()}).delegate(".ui-tabs-anchor","focus"+this.eventNamespace,function(){t(this).closest("li").is(".ui-state-disabled")&&this.blur()}),this.tabs=this.tablist.find("> li:has(a[href])").addClass("ui-state-default ui-corner-top").attr({role:"tab",tabIndex:-1}),this.anchors=this.tabs.map(function(){return t("a",this)[0]}).addClass("ui-tabs-anchor").attr({role:"presentation",tabIndex:-1}),this.panels=t(),this.anchors.each(function(i,s){var n,o,r,a=t(s).uniqueId().attr("id"),l=t(s).closest("li"),h=l.attr("aria-controls");e._isLocal(s)?(n=s.hash,r=n.substring(1),o=e.element.find(e._sanitizeSelector(n))):(r=l.attr("aria-controls")||t({}).uniqueId()[0].id,n="#"+r,o=e.element.find(n),o.length||(o=e._createPanel(r),o.insertAfter(e.panels[i-1]||e.tablist)),o.attr("aria-live","polite")),o.length&&(e.panels=e.panels.add(o)),h&&l.data("ui-tabs-aria-controls",h),l.attr({"aria-controls":r,"aria-labelledby":a}),o.attr("aria-labelledby",a)}),this.panels.addClass("ui-tabs-panel ui-widget-content ui-corner-bottom").attr("role","tabpanel"),i&&(this._off(i.not(this.tabs)),this._off(s.not(this.anchors)),this._off(n.not(this.panels)))},_getList:function(){return this.tablist||this.element.find("ol,ul").eq(0)},_createPanel:function(e){return t("<div>").attr("id",e).addClass("ui-tabs-panel ui-widget-content ui-corner-bottom").data("ui-tabs-destroy",!0)},_setupDisabled:function(e){t.isArray(e)&&(e.length?e.length===this.anchors.length&&(e=!0):e=!1);for(var i,s=0;i=this.tabs[s];s++)e===!0||-1!==t.inArray(s,e)?t(i).addClass("ui-state-disabled").attr("aria-disabled","true"):t(i).removeClass("ui-state-disabled").removeAttr("aria-disabled");this.options.disabled=e},_setupEvents:function(e){var i={};e&&t.each(e.split(" "),function(t,e){i[e]="_eventHandler"}),this._off(this.anchors.add(this.tabs).add(this.panels)),this._on(!0,this.anchors,{click:function(t){t.preventDefault()}}),this._on(this.anchors,i),this._on(this.tabs,{keydown:"_tabKeydown"}),this._on(this.panels,{keydown:"_panelKeydown"}),this._focusable(this.tabs),this._hoverable(this.tabs)},_setupHeightStyle:function(e){var i,s=this.element.parent();"fill"===e?(i=s.height(),i-=this.element.outerHeight()-this.element.height(),this.element.siblings(":visible").each(function(){var e=t(this),s=e.css("position");"absolute"!==s&&"fixed"!==s&&(i-=e.outerHeight(!0))}),this.element.children().not(this.panels).each(function(){i-=t(this).outerHeight(!0)}),this.panels.each(function(){t(this).height(Math.max(0,i-t(this).innerHeight()+t(this).height()))}).css("overflow","auto")):"auto"===e&&(i=0,this.panels.each(function(){i=Math.max(i,t(this).height("").height())}).height(i))},_eventHandler:function(e){var i=this.options,s=this.active,n=t(e.currentTarget),o=n.closest("li"),r=o[0]===s[0],a=r&&i.collapsible,l=a?t():this._getPanelForTab(o),h=s.length?this._getPanelForTab(s):t(),u={oldTab:s,oldPanel:h,newTab:a?t():o,newPanel:l};e.preventDefault(),o.hasClass("ui-state-disabled")||o.hasClass("ui-tabs-loading")||this.running||r&&!i.collapsible||this._trigger("beforeActivate",e,u)===!1||(i.active=a?!1:this.tabs.index(o),this.active=r?t():o,this.xhr&&this.xhr.abort(),h.length||l.length||t.error("jQuery UI Tabs: Mismatching fragment identifier."),l.length&&this.load(this.tabs.index(o),e),this._toggle(e,u))},_toggle:function(e,i){function s(){o.running=!1,o._trigger("activate",e,i)}function n(){i.newTab.closest("li").addClass("ui-tabs-active ui-state-active"),r.length&&o.options.show?o._show(r,o.options.show,s):(r.show(),s())}var o=this,r=i.newPanel,a=i.oldPanel;this.running=!0,a.length&&this.options.hide?this._hide(a,this.options.hide,function(){i.oldTab.closest("li").removeClass("ui-tabs-active ui-state-active"),n()}):(i.oldTab.closest("li").removeClass("ui-tabs-active ui-state-active"),a.hide(),n()),a.attr("aria-hidden","true"),i.oldTab.attr({"aria-selected":"false","aria-expanded":"false"}),r.length&&a.length?i.oldTab.attr("tabIndex",-1):r.length&&this.tabs.filter(function(){return 0===t(this).attr("tabIndex")}).attr("tabIndex",-1),r.attr("aria-hidden","false"),i.newTab.attr({"aria-selected":"true","aria-expanded":"true",tabIndex:0})},_activate:function(e){var i,s=this._findActive(e);s[0]!==this.active[0]&&(s.length||(s=this.active),i=s.find(".ui-tabs-anchor")[0],this._eventHandler({target:i,currentTarget:i,preventDefault:t.noop}))},_findActive:function(e){return e===!1?t():this.tabs.eq(e)},_getIndex:function(t){return"string"==typeof t&&(t=this.anchors.index(this.anchors.filter("[href$='"+t+"']"))),t},_destroy:function(){this.xhr&&this.xhr.abort(),this.element.removeClass("ui-tabs ui-widget ui-widget-content ui-corner-all ui-tabs-collapsible"),this.tablist.removeClass("ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all").removeAttr("role"),this.anchors.removeClass("ui-tabs-anchor").removeAttr("role").removeAttr("tabIndex").removeUniqueId(),this.tablist.unbind(this.eventNamespace),this.tabs.add(this.panels).each(function(){t.data(this,"ui-tabs-destroy")?t(this).remove():t(this).removeClass("ui-state-default ui-state-active ui-state-disabled ui-corner-top ui-corner-bottom ui-widget-content ui-tabs-active ui-tabs-panel").removeAttr("tabIndex").removeAttr("aria-live").removeAttr("aria-busy").removeAttr("aria-selected").removeAttr("aria-labelledby").removeAttr("aria-hidden").removeAttr("aria-expanded").removeAttr("role")}),this.tabs.each(function(){var e=t(this),i=e.data("ui-tabs-aria-controls");i?e.attr("aria-controls",i).removeData("ui-tabs-aria-controls"):e.removeAttr("aria-controls")}),this.panels.show(),"content"!==this.options.heightStyle&&this.panels.css("height","")},enable:function(e){var i=this.options.disabled;i!==!1&&(void 0===e?i=!1:(e=this._getIndex(e),i=t.isArray(i)?t.map(i,function(t){return t!==e?t:null}):t.map(this.tabs,function(t,i){return i!==e?i:null})),this._setupDisabled(i))},disable:function(e){var i=this.options.disabled;if(i!==!0){if(void 0===e)i=!0;else{if(e=this._getIndex(e),-1!==t.inArray(e,i))return;i=t.isArray(i)?t.merge([e],i).sort():[e]}this._setupDisabled(i)}},load:function(e,i){e=this._getIndex(e);var s=this,n=this.tabs.eq(e),o=n.find(".ui-tabs-anchor"),r=this._getPanelForTab(n),a={tab:n,panel:r},l=function(t,e){"abort"===e&&s.panels.stop(!1,!0),n.removeClass("ui-tabs-loading"),r.removeAttr("aria-busy"),t===s.xhr&&delete s.xhr};this._isLocal(o[0])||(this.xhr=t.ajax(this._ajaxSettings(o,i,a)),this.xhr&&"canceled"!==this.xhr.statusText&&(n.addClass("ui-tabs-loading"),r.attr("aria-busy","true"),this.xhr.done(function(t,e,n){
setTimeout(function(){r.html(t),s._trigger("load",i,a),l(n,e)},1)}).fail(function(t,e){setTimeout(function(){l(t,e)},1)})))},_ajaxSettings:function(e,i,s){var n=this;return{url:e.attr("href"),beforeSend:function(e,o){return n._trigger("beforeLoad",i,t.extend({jqXHR:e,ajaxSettings:o},s))}}},_getPanelForTab:function(e){var i=t(e).attr("aria-controls");return this.element.find(this._sanitizeSelector("#"+i))}}),t.widget("ui.tooltip",{version:"1.11.4",options:{content:function(){var e=t(this).attr("title")||"";return t("<a>").text(e).html()},hide:!0,items:"[title]:not([disabled])",position:{my:"left top+15",at:"left bottom",collision:"flipfit flip"},show:!0,tooltipClass:null,track:!1,close:null,open:null},_addDescribedBy:function(e,i){var s=(e.attr("aria-describedby")||"").split(/\s+/);s.push(i),e.data("ui-tooltip-id",i).attr("aria-describedby",t.trim(s.join(" ")))},_removeDescribedBy:function(e){var i=e.data("ui-tooltip-id"),s=(e.attr("aria-describedby")||"").split(/\s+/),n=t.inArray(i,s);-1!==n&&s.splice(n,1),e.removeData("ui-tooltip-id"),s=t.trim(s.join(" ")),s?e.attr("aria-describedby",s):e.removeAttr("aria-describedby")},_create:function(){this._on({mouseover:"open",focusin:"open"}),this.tooltips={},this.parents={},this.options.disabled&&this._disable(),this.liveRegion=t("<div>").attr({role:"log","aria-live":"assertive","aria-relevant":"additions"}).addClass("ui-helper-hidden-accessible").appendTo(this.document[0].body)},_setOption:function(e,i){var s=this;return"disabled"===e?(this[i?"_disable":"_enable"](),void(this.options[e]=i)):(this._super(e,i),void("content"===e&&t.each(this.tooltips,function(t,e){s._updateContent(e.element)})))},_disable:function(){var e=this;t.each(this.tooltips,function(i,s){var n=t.Event("blur");n.target=n.currentTarget=s.element[0],e.close(n,!0)}),this.element.find(this.options.items).addBack().each(function(){var e=t(this);e.is("[title]")&&e.data("ui-tooltip-title",e.attr("title")).removeAttr("title")})},_enable:function(){this.element.find(this.options.items).addBack().each(function(){var e=t(this);e.data("ui-tooltip-title")&&e.attr("title",e.data("ui-tooltip-title"))})},open:function(e){var i=this,s=t(e?e.target:this.element).closest(this.options.items);s.length&&!s.data("ui-tooltip-id")&&(s.attr("title")&&s.data("ui-tooltip-title",s.attr("title")),s.data("ui-tooltip-open",!0),e&&"mouseover"===e.type&&s.parents().each(function(){var e,s=t(this);s.data("ui-tooltip-open")&&(e=t.Event("blur"),e.target=e.currentTarget=this,i.close(e,!0)),s.attr("title")&&(s.uniqueId(),i.parents[this.id]={element:this,title:s.attr("title")},s.attr("title",""))}),this._registerCloseHandlers(e,s),this._updateContent(s,e))},_updateContent:function(t,e){var i,s=this.options.content,n=this,o=e?e.type:null;return"string"==typeof s?this._open(e,t,s):(i=s.call(t[0],function(i){n._delay(function(){t.data("ui-tooltip-open")&&(e&&(e.type=o),this._open(e,t,i))})}),void(i&&this._open(e,t,i)))},_open:function(e,i,s){function n(t){h.of=t,r.is(":hidden")||r.position(h)}var o,r,a,l,h=t.extend({},this.options.position);if(s){if(o=this._find(i))return void o.tooltip.find(".ui-tooltip-content").html(s);i.is("[title]")&&(e&&"mouseover"===e.type?i.attr("title",""):i.removeAttr("title")),o=this._tooltip(i),r=o.tooltip,this._addDescribedBy(i,r.attr("id")),r.find(".ui-tooltip-content").html(s),this.liveRegion.children().hide(),s.clone?(l=s.clone(),l.removeAttr("id").find("[id]").removeAttr("id")):l=s,t("<div>").html(l).appendTo(this.liveRegion),this.options.track&&e&&/^mouse/.test(e.type)?(this._on(this.document,{mousemove:n}),n(e)):r.position(t.extend({of:i},this.options.position)),r.hide(),this._show(r,this.options.show),this.options.show&&this.options.show.delay&&(a=this.delayedShow=setInterval(function(){r.is(":visible")&&(n(h.of),clearInterval(a))},t.fx.interval)),this._trigger("open",e,{tooltip:r})}},_registerCloseHandlers:function(e,i){var s={keyup:function(e){if(e.keyCode===t.ui.keyCode.ESCAPE){var s=t.Event(e);s.currentTarget=i[0],this.close(s,!0)}}};i[0]!==this.element[0]&&(s.remove=function(){this._removeTooltip(this._find(i).tooltip)}),e&&"mouseover"!==e.type||(s.mouseleave="close"),e&&"focusin"!==e.type||(s.focusout="close"),this._on(!0,i,s)},close:function(e){var i,s=this,n=t(e?e.currentTarget:this.element),o=this._find(n);return o?(i=o.tooltip,void(o.closing||(clearInterval(this.delayedShow),n.data("ui-tooltip-title")&&!n.attr("title")&&n.attr("title",n.data("ui-tooltip-title")),this._removeDescribedBy(n),o.hiding=!0,i.stop(!0),this._hide(i,this.options.hide,function(){s._removeTooltip(t(this))}),n.removeData("ui-tooltip-open"),this._off(n,"mouseleave focusout keyup"),n[0]!==this.element[0]&&this._off(n,"remove"),this._off(this.document,"mousemove"),e&&"mouseleave"===e.type&&t.each(this.parents,function(e,i){t(i.element).attr("title",i.title),delete s.parents[e]}),o.closing=!0,this._trigger("close",e,{tooltip:i}),o.hiding||(o.closing=!1)))):void n.removeData("ui-tooltip-open")},_tooltip:function(e){var i=t("<div>").attr("role","tooltip").addClass("ui-tooltip ui-widget ui-corner-all ui-widget-content "+(this.options.tooltipClass||"")),s=i.uniqueId().attr("id");return t("<div>").addClass("ui-tooltip-content").appendTo(i),i.appendTo(this.document[0].body),this.tooltips[s]={element:e,tooltip:i}},_find:function(t){var e=t.data("ui-tooltip-id");return e?this.tooltips[e]:null},_removeTooltip:function(t){t.remove(),delete this.tooltips[t.attr("id")]},_destroy:function(){var e=this;t.each(this.tooltips,function(i,s){var n=t.Event("blur"),o=s.element;n.target=n.currentTarget=o[0],e.close(n,!0),t("#"+i).remove(),o.data("ui-tooltip-title")&&(o.attr("title")||o.attr("title",o.data("ui-tooltip-title")),o.removeData("ui-tooltip-title"))}),this.liveRegion.remove()}})}),!function(t){if("function"==typeof define&&define.amd)define(t);else if("object"==typeof exports)module.exports=t();else{var e=window.Cookies,i=window.Cookies=t();i.noConflict=function(){return window.Cookies=e,i}}}(function(){function t(){for(var t=0,e={};t<arguments.length;t++){var i=arguments[t];for(var s in i)e[s]=i[s]}return e}function e(i){function s(e,n,o){var r;if("undefined"!=typeof document){if(arguments.length>1){if(o=t({path:"/"},s.defaults,o),"number"==typeof o.expires){var a=new Date;a.setMilliseconds(a.getMilliseconds()+864e5*o.expires),o.expires=a}try{r=JSON.stringify(n),/^[\{\[]/.test(r)&&(n=r)}catch(l){}return n=i.write?i.write(n,e):encodeURIComponent(String(n)).replace(/%(23|24|26|2B|3A|3C|3E|3D|2F|3F|40|5B|5D|5E|60|7B|7D|7C)/g,decodeURIComponent),e=encodeURIComponent(String(e)),e=e.replace(/%(23|24|26|2B|5E|60|7C)/g,decodeURIComponent),e=e.replace(/[\(\)]/g,escape),document.cookie=[e,"=",n,o.expires&&"; expires="+o.expires.toUTCString(),o.path&&"; path="+o.path,o.domain&&"; domain="+o.domain,o.secure?"; secure":""].join("")}e||(r={});for(var h=document.cookie?document.cookie.split("; "):[],u=/(%[0-9A-Z]{2})+/g,c=0;c<h.length;c++){var d=h[c].split("="),p=d[0].replace(u,decodeURIComponent),f=d.slice(1).join("=");'"'===f.charAt(0)&&(f=f.slice(1,-1));try{if(f=i.read?i.read(f,p):i(f,p)||f.replace(u,decodeURIComponent),this.json)try{f=JSON.parse(f)}catch(l){}if(e===p){r=f;break}e||(r[p]=f)}catch(l){}}return r}}return s.set=s,s.get=function(t){return s(t)},s.getJSON=function(){return s.apply({json:!0},[].slice.call(arguments))},s.defaults={},s.remove=function(e,i){s(e,"",t(i,{expires:-1}))},s.withConverter=e,s}return e(function(){})});var z=jQuery.noConflict(!0);z(document).ready(function(){function t(){if(b!==!0){var t="Global Address Verification is not enabled.";return z("#errorresults_top").append(t),z("#errorresults_top").css("display","block"),void z("#errorresults_top").fadeOut(6800)}var e,i,s="",n=z("#billing\\:city").val(),o=z("#billing\\:postcode").val(),r=z("#billing\\:street1").val(),l=z("#billing\\:street2").val(),h=z("#showCountryResults").find(":selected").val(),u=z("#showCountryResultsSingleRow").find(":selected").val();return console.log("c1: "+h+" -> c2: "+u),"undefined"==typeof h||"string"!=typeof h.valueOf()||2!=h.length&&3!=h.length?"undefined"==typeof u||"string"!=typeof u.valueOf()||2!=u.length&&3!=u.length||(e=u):e=h,n=z.trim(n),o=z.trim(o),r=z.trim(r),l=z.trim(l),e=z.trim(e),i=z.trim(i),console.log("doGawsWebCall [Live Input]: Locality:"+n+" - Street: "+r+" - Street2: "+l+" - PostalCode: "+o+" - Country: "+e),z.ajax({type:"GET",url:k,dataType:"jsonp",async:!0,cache:!1,data:{id:a,t:"Melissa Data Magento Plugin - Address Check (SE)",format:"json",ctry:e,a1:r,a2:l,postal:o,loc:n},success:function(t){var e=JSON.stringify(t),i=z.parseJSON(e);console.log("Data: "+e);var n=JSON.stringify(i.Records),o=z.parseJSON(n),r=o[0].Results,a=(r.split(","),o[0].FormattedAddress),h=(o[0].Latitude,o[0].Longitude,o[0].Locality),u=o[0].PostalCode,c=o[0].AddressLine1,d=o[0].AddressLine2,p=(o[0].AddressLine3,o[0].AddressLine4,o[0].AddressLine5,o[0].Thoroughfare,o[0].CountryName,o[0].AdministrativeArea,o[0].SubNationalArea,o[0].CountryISO3166_1_Alpha3,o[0].CountryISO3166_1_Alpha2);o[0].PremisesNumber,o[0].SubPremisesNumber;console.log("doGawsWebCall [live] ResultCodes:"+o[0].Results+" - FormAddr: "+a),null!=r.match(/(AV23|AV24|AV25)/gi)?(s='Address: <span style="text-decoration: underline;">'+a+"</span> is a good address.",html_result_gaws='<span style="color: green; font-weight:bold;">'+s+"</span>",z("#billing\\:street1").val(c),z("#billing\\:postcode").val(u),z("#billing\\:city").val(h),null!=p.match(/(GB|UK|US|AU|NL)/gi)&&l.length>=2&&z("#billing\\:street2").val(d)):null!=r.match(/(AV1|AE05|AV21|AV22)/gi)?(s='Address: <span style="text-decoration: underline;">'+a+"</span> may or may not be a deliverable. <br> Please verify the address input.",html_result_gaws='<span style="color: orange; font-weight:bold;">'+s+"</span>"):null!=r.match(/(AE..)/gi)&&null==r.match(/(AE05)/gi)&&(s='Address: <span style="text-decoration: underline;">'+a+"</span> is a bad address. <br> Please double check the address input.",html_result_gaws='<span style="color: red; font-weight:bold;">'+s+"</span>"),z("#gawsresults_top").html(""),z("#gawsresults_top").html(html_result_gaws),z("#gawsresults_top").css("display","block")}}),0}function e(){if(y!==!0){var t="Global Email Validation is not enabled.";return z("#errorresults_top").append(t),z("#errorresults_top").css("display","block"),void z("#errorresults_top").fadeOut(6800)}var e="",i=z("#billing\\:email").val();i=z.trim(i);i.includes("@"),i.includes(".");return z.ajax({type:"GET",url:D,dataType:"jsonp",async:!0,cache:!1,data:{id:l,t:"Melissa Data Magento Plugin - Email Check (SE)",opt:"VERIFYMAILBOX:Express,DomainCorrection:On",format:"json",email:i},success:function(t){var i=JSON.stringify(t),s=z.parseJSON(i),n=JSON.stringify(s.Records),o=z.parseJSON(n),r=o[0].Results,a=r.split(","),l=o[0].EmailAddress,h=(o[0].MailboxName,o[0].DomainName,o[0].TopLevelDomain,o[0].TopLevelDomainName,""),u=0;z.each(a,function(t,e){e=e.trim(),null!=e.match(/ES01/gi)&&u++,null!=e.match(/ES20/gi)&&u++});var c=0;return null!=r.match(/(EE01|EE02|EE03|EE04|ES02|ES03|ES04|ES05|ES06|ES09)/gi)?(e='eMail: <span style="text-decoration: underline;">'+l+"</span> is not a deliverable Email address.",h=' <span style="color: red; font-weight:bold;">'+e+"</span>",c=0):null!=r.match(/(ES07|ES08)/gi)||2==u?(e='eMail: <span style="text-decoration: underline;">'+l+"</span> may or may not be deliverable. <br>  The ISP is an accept-all or does not allow real-time verification.",h=' <span style="color: orange; font-weight:bold;">'+e+"</span>",c=0):null!=r.match(/(ES01|ES20|ES21|ES22)/gi)&&2!=u&&(e='eMail: <span style="text-decoration: underline;">'+l+"</span> is found to be deliverable.",h=' <span style="color: green; font-weight:bold;">'+e+"</span>",c=1),z("#gawsresults_top").append(h),z("#gawsresults_top").css("display","block"),c}}),0}var s=25,n=225,o=450,r=Cookies.get("MelissaDataMagento_GEE_Token"),a=Cookies.get("MelissaDataMagento_GAWS_Token"),l=Cookies.get("MelissaDataMagento_EMAIL_Token"),h=Cookies.get("MelissaDataMagento_EMAIL_ENABLED"),u=Cookies.get("MelissaDataMagento_GAWS_ENABLED"),c=Cookies.get("MelissaDataMagento_GEE_ENABLED"),d=Cookies.get("MelissaDataMagento_GEE_SINGLEROWCOUNTRIES"),p=Cookies.get("MelissaDataMagento_GEE_SINGLEROW_ENABLED"),f=Cookies.get("MelissaDataMagento_GEE_MULTIROW_ENABLED"),g=p.includes("1"),m=f.includes("1"),v=c.includes("1"),b=u.includes("1"),y=h.includes("1"),_=(d.split(","),"https://expressentry.melissadata.net/jsonp/GlobalExpressPostalCode"),w="https://expressentry.melissadata.net/jsonp/GlobalExpressCountry",_="https://expressentry.melissadata.net/jsonp/GlobalExpressPostalCode",x="https://expressentry.melissadata.net/jsonp/GlobalExpressAddress",C="https://expressentry.melissadata.net/jsonp/GlobalExpressFreeForm",k="https://address.melissadata.net/V3/WEB/GlobalAddress/doGlobalAddress",D="https://globalemail.melissadata.net/v3/WEB/GlobalEmail/doGlobalEmail",S='<div id="London" class="tabcontent"><br /><p><table id="autocomplete_melissadata_singlerow" border="0px;"><tr style="font-weight: bold; font-size: 140%;"><b id="singleShow">Melissa Data Single Row Autocompletion</b></tr><tr width="" style="clear:both;"><td><br /></td></tr><tr style="clear:both;"><td width="'+n+'px"><input type="text" value="" placeholder="1. Type Country" title="Start typing a country name to get Suggestions" id="CountrySuggestionsSingleRow" style="width: '+n+'px;" /><span id="showCountryResultsSingleRow" style="height:75px;line-height:3em;overflow:auto;padding:5px;"></span></td><td width="'+o+'px"><input type="text" value="" placeholder="2. Type Address" title="Start typing a Postal code & Address to get Suggestions from within that Country" id="AddressSuggestionsSingleRow" style="width: '+o+'px;" /><span id="showAddressResultsSingleRow" style="width: '+o+'px; height:75px;line-height:3em;overflow:auto;padding:5px;"></span></td><td width="'+n+'px"><input type="text" value="" placeholder="3. Choose Suite" title="Choose an Apartment Number for that Address" id="SubBuildingSingleRow" style="width: '+n+'px;" /><span id="showAddressSubPremise" style="width: '+o+'px; height:75px;line-height:3em;overflow:auto;padding:5px;"></span></td></tr></table></p><br /><br /></div>',T='<div id="Paris" class="tabcontent"><br /><p><table id="autocomplete_melissadata_fielded" border="0px;"><tr style="font-weight: bold; font-size: 140%;"><b id="multiShow">Melissa Data Fielded Autocompletion</b></tr><tr width="'+3*n+'px"><td><br /></td></tr><tr style="clear:both;"><td width="'+n+'px"><input type="text" value="" placeholder="1. Type Country" title="Start typing a country name to get Suggestions" id="CountrySuggestions" style="width: '+n+'px;" /><span id="showCountryResults" style="width:150px;height:75px;line-height:3em;overflow:auto;padding:5px;"></span></td><td width="'+n+'px"><input type="text" value="" placeholder="2. Type Postal Code" title="Start typing a Postal code to get Suggestions from within that Country" id="PostalCodeSuggestions" style="width: '+n+'px;" /><span id="showPostalCodeResults" style="width:150px;height:75px;line-height:3em;overflow:auto;padding:5px;"></span></td><td width="'+n+'px"><input type="text" value="" placeholder="3. Type Street Address" title="Start typing a street name to get suggestions for them within that Postal code range in that country" id="StreetSuggestions" style="width: '+n+'px;" /><span id="showStreetResults" style="height:75px;line-height:3em;overflow:auto;padding:5px;"></span></td><td width="'+n+'px"><input type="text" value="" placeholder="4. Choose Suite" title="Choose an Apartment Number for that Address" id="SubBuildingSuggestions" style="width: '+n+'px;" /><span id="showSubPremise" style="width: '+o+'px; height:75px;line-height:3em;overflow:auto;padding:5px;"></tr></table></p><br /><br /><p></div>',P='<ul class="tab"><li><a href="#" class="tablinks" onclick="openMDElement(event, \'London\')">Single Row Autocompletion</a></li><li><a href="#" class="tablinks" onclick="openMDElement(event, \'Paris\')">Fielded Autocompletion</a></li></ul>';if(v===!0&&(z("#checkout-step-billing").css("display","inline"),z(P).insertBefore("#checkout-step-billing"),g===!0&&z(S).insertBefore("#checkout-step-billing"),m===!0&&z(T).insertBefore("#checkout-step-billing")),b===!0&&y===!0){var A='<form id="formaction"><input type="button" id="submitCheck" title="Verify now the Input Address Values" value=" Verify "></form><br /><span id="gawsresults_top" style="display:none;"></span><br /><span id="errorresults_top" style="display:none;"></span>';z(A).insertBefore("#checkout-step-billing"),z("#checkout-step-billing").css("display","inline"),z("#billing\\:region_id").css("display","inline")}else if(b===!0){var A='<form><input type="button" id="submitCheck" title="Verify now the Input Address Values" value=" Verify "></form><br /><span id="gawsresults_top" style="display:none;"></span><br /><span id="errorresults_top" style="display:none;"></span>';z(A).insertBefore("#checkout-step-billing"),z("#checkout-step-billing").css("display","inline"),z("#billing\\:region_id").css("display","inline")}else if(y===!0){var I='<form><input type="button" id="submitCheck" title="Verify now the Input Address Values" value=" Verify Now "></form><br /><span id="gawsresults_top" style="display:none;"></span><br /><span id="errorresults_top" style="display:none;"></span>';z(I).insertBefore("#checkout-step-billing"),z("#checkout-step-billing").css("display","inline"),z("#billing\\:region_id").css("display","inline")}z("#showCountryResults").on("click",function(){var t=z("#showCountryResults").find(":selected").val(),e=z("#showCountryResults").find(":selected").text(),i='<option selected value="'+t+'">'+e+"</option>",s=new Array;s.push('<select style="width: '+n+'px;" size="10">'),s.push(i),s.push("</select>");var o=s.join(""),r=0;1==r?(z("#autocomplete_melissadata_singlerow").show(),z("#autocomplete_melissadata_fielded").hide(),z("#CountrySuggestionsSingleRow").val(""),z("#CountrySuggestionsSingleRow").html(""),z("#CountrySuggestionsSingleRow").val(e),z("#showAddressResultsSingleRow").html(""),z("#showAddressResultsSingleRow").val(""),z("#AddressSuggestionsSingleRow").html(""),z("#AddressSuggestionsSingleRow").val(""),z("#AddressSuggestionsSingleRow").focus(),z("#showAddressResultsSingleRow").focus(),z("#AddressResultsSingleRow").focus(),z("#showCountryResultsSingleRow").hide(),z("#showCountryResultsSingleRow").html(o)):(z("#CountrySuggestions").val(""),z("#CountrySuggestions").html(""),z("#CountrySuggestions").val(e),z("#PostalCodeSuggestions").val(""),z("#showPostalCodeResults").val(""),z("#PostalCodeSuggestions").html(""),z("#showPostalCodeResults").html(""),z("#billing\\:street1").val(""),z("#showStreetResults").val(""),z("#showStreetResults").html(""),z("#StreetSuggestions").val(""),z("#StreetSuggestions").html(""),z("#PostalCodeSuggestions").focus(),z("#showPostalCodeResults").focus(),z("#showCountryResults").html(o),z("#showCountryResults").hide()),res="Country selected.",html_result_gaws='<span style="color: green; font-weight:bold;">'+res+"</span>",z("#gawsresults_top").html(html_result_gaws),z("#gawsresults_top").css("display","block")}),z("#showAddressSubPremise").on("click",function(){var t=z("#showAddressSubPremise").find(":selected").val(),e=z("#showAddressResultsSingleRow").find(":selected").attr("deliver"),i=(z("#showPostalCodeResults").find(":selected").attr("pc"),z("#showAddressSubPremise").find(":selected").attr("pc_sec")),s=z("#showCountryResultsSingleRow").find(":selected").val();z("#billing\\:street1").val(""),z("#billing\\:street1").html("");var n=z("#showAddressResultsSingleRow").find(":selected").attr("organization"),o=z("#showAddressResultsSingleRow").find(":selected").attr("building"),r=z("#showAddressResultsSingleRow").find(":selected").attr("premise"),a=z("#showAddressResultsSingleRow").find(":selected").attr("thoroughfare");if(i.length>2&&-1!=s.toLowerCase().indexOf("us")&&(z("#billing\\:postcode").val(""),z("#billing\\:postcode").html(""),z("#billing\\:postcode").val(i),console.log("Setting Postal Code ZIP9:"+i)),-1!=s.toLowerCase().indexOf("gb")){var l=new Array;l.push(n),l.push(o),l=l.filter(function(t){return t});var h=l.join(","),u=new Array;u.push(t),u.push(r+" "+a),u=u.filter(function(t){return t});var c=u.join(",");z("#billing\\:street1").val(h),z("#billing\\:street2").val(c)}else console.log("Set apartment number with street2: "+t),z("#billing\\:street1").val(e),z("#billing\\:street2").val(t);z("#SubBuildingSingleRow").val(""),z("#SubBuildingSingleRow").html(""),z("#SubBuildingSingleRow").val(t),z("#showAddressSubPremise").val(""),z("#showAddressSubPremise").html(""),z("#showAddressSubPremise").val(t),res="Suite selected.",html_result_gaws='<span style="color: green; font-weight:bold;">'+res+"</span>",z("#gawsresults_top").html(html_result_gaws),z("#gawsresults_top").css("display","block")}),z("#showSubPremise").on("click",function(){var t=z("#showSubPremise").find(":selected").val(),e=(z("#showPostalCodeResults").find(":selected").attr("pc"),z("#showSubPremise").find(":selected").attr("pc_sec")),i=Cookies.get("MelissaDataMagento_deliveryaddr"),s=z("#showCountryResults").find(":selected").val();z("#billing\\:street1").val(""),z("#billing\\:street1").html("");var n=z("#showStreetResults").find(":selected").attr("organization"),o=z("#showStreetResults").find(":selected").attr("building"),r=z("#showStreetResults").find(":selected").attr("premise"),a=z("#showStreetResults").find(":selected").attr("thoroughfare");if(e.length>2&&-1!=s.toLowerCase().indexOf("us")&&(z("#billing\\:postcode").val(""),z("#billing\\:postcode").html(""),z("#billing\\:postcode").val(e),console.log("Setting Postal Code ZIP9:"+e)),-1!=s.toLowerCase().indexOf("gb")){var l=new Array;l.push(n),l.push(o),l=l.filter(function(t){return t});var h=l.join(","),u=new Array;u.push(t),u.push(r+" "+a),u=u.filter(function(t){return t});var c=u.join(",");z("#billing\\:street1").val(h),z("#billing\\:street2").val(c)}else console.log("Set apartment number with street2: "+t+" and delivery: "+i),z("#billing\\:street1").val(i),z("#billing\\:street2").val(t);z("#SubBuildingSuggestions").val(""),z("#SubBuildingSuggestions").html(""),z("#SubBuildingSuggestions").val(t),z("#showSubPremise").val(""),z("#showSubPremise").html(""),z("#showSubPremise").val(t),res="Suite selected.",html_result_gaws='<span style="color: green; font-weight:bold;">'+res+"</span>",z("#gawsresults_top").html(html_result_gaws),z("#gawsresults_top").css("display","block")}),z("#showPostalCodeResults").on("click",function(){var t=z("#showPostalCodeResults").find(":selected").val(),e=z("#showPostalCodeResults").find(":selected").attr("pc");z("#showCountryResults").find(":selected").val(),z("#showCountryResults").find(":selected").text();z("#PostalCodeSuggestions").val(""),z("#PostalCodeSuggestions").html(""),z("#PostalCodeSuggestions").val(e+", "+t),z("#billing\\:city").val(t),z("#billing\\:postcode").val(e),z("#billing\\:street1").val(""),z("#showStreetResults").val(""),z("#showStreetResults").html(""),z("#StreetSuggestions").val(""),z("#StreetSuggestions").html(""),z("#showStreetResults").focus(),z("#StreetSuggestions").focus(),z("#showPostalCodeResults").hide(),res="Postal Code selected.",html_result_gaws='<span style="color: green; font-weight:bold;">'+res+"</span>",z("#gawsresults_top").html(html_result_gaws),z("#gawsresults_top").css("display","block")}),z("#showCountryResultsSingleRow").on("click",function(){var t=(z("#showCountryResultsSingleRow").find(":selected").val(),z("#showCountryResultsSingleRow").find(":selected").text());z("#CountrySuggestionsSingleRow").val(""),z("#CountrySuggestionsSingleRow").html(""),z("#CountrySuggestionsSingleRow").val(t),z("#showAddressResultsSingleRow").html(""),z("#showAddressResultsSingleRow").val(""),z("#AddressSuggestionsSingleRow").html(""),z("#AddressSuggestionsSingleRow").val(""),z("#AddressSuggestionsSingleRow").focus(),z("#showAddressResultsSingleRow").focus(),z("#AddressResultsSingleRow").focus(),z("#showCountryResultsSingleRow").hide(),res="Country selected.",html_result_gaws='<span style="color: green; font-weight:bold;">'+res+"</span>",z("#gawsresults_top").html(html_result_gaws),z("#gawsresults_top").css("display","block")}),z("#showStreetResults").on("click",function(){var t=z("#showStreetResults").find(":selected").val(),e=z("#showStreetResults").find(":selected").attr("loc"),i=z("#showPostalCodeResults").find(":selected").attr("pc"),n=z("#showStreetResults").find(":selected").attr("pc_sec"),r=z("#showStreetResults").find(":selected").attr("deliver"),a=(z("#showStreetResults").find(":selected").attr("aarea"),z("#showStreetResults").find(":selected").attr("simpleaddr"),z("#showStreetResults").find(":selected").attr("subbuilding")),l=a.split(","),h=n.toString().split(","),u=z("#showCountryResults").find(":selected").val();z("#showCountryResults").find(":selected").text();Cookies.set("MelissaDataMagento_deliveryaddr",r);var c=z("#showStreetResults").find(":selected").attr("organization"),d=z("#showStreetResults").find(":selected").attr("building"),p=z("#showStreetResults").find(":selected").attr("premise"),f=z("#showStreetResults").find(":selected").attr("thoroughfare");if(-1!=u.toLowerCase().indexOf("gb")){var g=new Array;g.push(c),g.push(d),g=g.filter(function(t){return t});var m=g.join(","),v=new Array;v.push(p+" "+f),v=v.filter(function(t){return t});var b=v.join(",");console.log("GB Postalcode: #showStreetResults "+i),z("#billing\\:street1").val(m),z("#billing\\:street2").val(b),z("#billing\\:city").val(e),z("#billing\\:postcode").val(i)}else console.log("not GB Postalcode: #showStreetResults "+i),z("#billing\\:city").val(e),z("#billing\\:postcode").val(i),z("#billing\\:street1").val(r),z("#billing\\:street2").val("");z("#StreetSuggestions").val(""),z("#StreetSuggestions").html(""),z("#StreetSuggestions").val(t),z("#showStreetResults").val(""),z("#showStreetResults").html(""),z("#showStreetResults").val(t),res="Address selected.",html_result_gaws='<span style="color: green; font-weight:bold;">'+res+"</span>",z("#gawsresults_top").html(html_result_gaws),z("#gawsresults_top").css("display","block"),z("#SubBuildingSuggestions").focus(),z("#showSubPremise").focus();var y=1;if(1==y&&"undefined"!=typeof l[0]&&null!=l[0]&&l[0].length>0){var _=new Array,w=1,x=o+100;_.push('<select style="width: '+x+'px;" size="25">'),z.each(l,function(t,e){e=e.trim();var n=i+"-"+h[t];"undefined"!=typeof e&&"string"==typeof e.valueOf()&&e.length>=1&&(w>=0?(_.push('<option selected pc_sec="'+n+'" value="'+e+'">'+e+"</option>"),w++):w>=1&&s>=w&&(_.push('<option pc_sec="'+n+'" value="'+e+'">'+e+"</option>"),w++))}),_.push("</select>");var C=_.join("");z("#SubBuildingSuggestions").focus(),z("#showSubPremise").focus(),z("#showSubPremise").html(""),z("#showSubPremise").val(""),z("#showSubPremise").html(C),z("#showSubPremise").css("display","inline"),z("#showSubPremise").show()}}),z("#showAddressResultsSingleRow").on("click",function(){var t=z("#showAddressResultsSingleRow").find(":selected").val(),e=z("#showAddressResultsSingleRow").find(":selected").attr("loc"),i=z("#showAddressResultsSingleRow").find(":selected").attr("pc"),n=z("#showAddressResultsSingleRow").find(":selected").attr("pc_sec"),r=z("#showAddressResultsSingleRow").find(":selected").attr("deliver"),a=(z("#showAddressResultsSingleRow").find(":selected").attr("aarea"),z("#showAddressResultsSingleRow").find(":selected").attr("simpleaddr"),z("#showAddressResultsSingleRow").find(":selected").attr("subbuilding")),l=a.split(","),h=n.toString().split(","),u=z("#showCountryResultsSingleRow").find(":selected").val(),c=(z("#showCountryResultsSingleRow").find(":selected").text(),z("#showAddressResultsSingleRow").find(":selected").attr("organization")),d=z("#showAddressResultsSingleRow").find(":selected").attr("building"),p=(z("#showAddressResultsSingleRow").find(":selected").attr("subbuilding"),z("#showAddressResultsSingleRow").find(":selected").attr("premise")),f=z("#showAddressResultsSingleRow").find(":selected").attr("thoroughfare");if(-1!=u.toLowerCase().indexOf("gb")){var g=new Array;g.push(c),g.push(d),g=g.filter(function(t){return t});var m=g.join(","),v=new Array;v.push(p+" "+f),v=v.filter(function(t){return t});var b=v.join(",");z("#billing\\:street1").val(m),z("#billing\\:street2").val(b),z("#billing\\:city").val(e),z("#billing\\:postcode").val(i)}else z("#billing\\:city").val(e),z("#billing\\:postcode").val(i),z("#billing\\:street1").val(r),z("#billing\\:street2").val("");z("#AddressSuggestionsSingleRow").val(""),z("#AddressSuggestionsSingleRow").html(""),z("#AddressSuggestionsSingleRow").val(t),z("#showAddressResultsSingleRow").hide(),res="Street and House Number have been chosen.",html_result_gaws='<span style="color: green; font-weight:bold;">'+res+"</span>",z("#gawsresults_top").html(html_result_gaws),z("#gawsresults_top").css("display","block");var y=1;if(1==y&&"undefined"!=typeof l[0]&&null!=l[0]&&l[0].length>0){var _=new Array,w=1,x=o+100;_.push('<select style="width: '+x+'px;" size="25">'),z.each(l,function(t,e){e=e.trim();var n=i+"-"+h[t];"undefined"!=typeof e&&"string"==typeof e.valueOf()&&e.length>=1&&(w>=0?(_.push('<option selected pc_sec="'+n+'" value="'+e+'">'+e+"</option>"),w++):w>=1&&s>=w&&(_.push('<option pc_sec="'+n+'" value="'+e+'">'+e+"</option>"),w++))}),_.push("</select>");var C=_.join("");z("#SubBuildingSingleRow").focus(),z("#showAddressSubPremise").focus(),z("#showAddressSubPremise").html(""),z("#showAddressSubPremise").val(""),z("#showAddressSubPremise").html(C),z("#showAddressSubPremise").css("display","inline"),z("#showAddressSubPremise").show()}}),v===!0&&(z("#AddressSuggestionsSingleRow").autocomplete({showHeader:!0,minLength:1,delay:250,source:function(t,e){z.ajax({url:C,dataType:"jsonp",data:{maxrecords:s,ff:z("#AddressSuggestionsSingleRow").val(),country:z("#showCountryResultsSingleRow").find(":selected").val(),id:r,format:"jsonp",nativecharset:!1},success:function(t){function e(t){var o="",a="";for(i in t){z("#showCountryResultsSingleRow").find(":selected").val();a=t.Address,simpleaddr=t.Address2,loc=t.Locality,o=t.PostalCode,pc_sec=t.PostalCodeSecondary,aarea=t.AdministrativeArea,deliver=t.DeliveryAddress,subbuilding=t.SubBuilding,organization=t.Organization,building=t.Building,premise=t.Premise,tn=t.Thoroughfare,"undefined"!=typeof a&&"string"==typeof a.valueOf()&&a.length>0&&(l>=0?(r.push('<option selected value="'+a+'" organization="'+organization+'" building="'+building+'" premise="'+premise+'" thoroughfare="'+tn+'" subbuilding="'+subbuilding+'" loc="'+loc+'" pc_sec="'+pc_sec+'" pc="'+o+'" aarea="'+aarea+'" simpleaddr="'+simpleaddr+'" deliver="'+deliver+'">'+a+"</option>"),l++):l>=1&&s>=l&&(r.push('<option value="'+a+'" organization="'+organization+'" building="'+building+'" premise="'+premise+'" thoroughfare="'+tn+'" subbuilding="'+subbuilding+'" loc="'+loc+'" pc_sec="'+pc_sec+'" pc="'+o+'" aarea="'+aarea+'" simpleaddr="'+simpleaddr+'" deliver="'+deliver+'">'+a+"</option>"),l++)),"object"==typeof t[i]&&e(t[i])}return n(r).join("")}function n(t){var e={};return t.filter(function(t){return e.hasOwnProperty(t)?!1:e[t]=!0})}var r=new Array,a=new Array,l=1,h=o+100;a.push('<select style="width: '+h+'px;" size="10">');var u=JSON.stringify(t),c=z.parseJSON(u),d=JSON.stringify(c.Results),p=z.parseJSON(d),f=e(p);a.push(f),a.push("</select>");var g=a.join("");z("#showAddressResultsSingleRow").html(""),z("#showAddressResultsSingleRow").val(""),z("#showAddressResultsSingleRow").html(g),z("#showAddressResultsSingleRow").show(),r=[]}})}}),z("#StreetSuggestions").autocomplete({showHeader:!0,minLength:1,delay:250,source:function(t,e){z.ajax({url:x,dataType:"jsonp",data:{maxrecords:s,address1:z("#StreetSuggestions").val(),locality:z("#showPostalCodeResults").find(":selected").val(),postalcode:z("#showPostalCodeResults").find(":selected").attr("pc"),country:z("#showCountryResults").find(":selected").val(),id:r,format:"jsonp",nativecharset:!1},success:function(t){function e(t){var n="",a="";
for(i in t)a=t.DeliveryAddress,simpleaddr=t.DeliveryAddress,loc=t.Locality,n=t.PostalCode,pc_sec=t.PostalCodeSecondary,aarea=t.AdministrativeArea,deliver=t.DeliveryAddress,subbuilding=t.SubBuilding,organization=t.Organization,building=t.Building,premise=t.Premise,tn=t.Thoroughfare,console.log("sub building:"+subbuilding),"undefined"!=typeof a&&"string"==typeof a.valueOf()&&a.length>0&&(l>=0?(r.push('<option selected value="'+a+'" organization="'+organization+'" building="'+building+'" premise="'+premise+'" thoroughfare="'+tn+'" subbuilding="'+subbuilding+'" loc="'+loc+'" pc_sec="'+pc_sec+'" pc="'+n+'" aarea="'+aarea+'" simpleaddr="'+simpleaddr+'" deliver="'+deliver+'">'+a+"</option>"),l++):l>=1&&s>=l&&(r.push('<option value="'+a+'" organization="'+organization+'" building="'+building+'" premise="'+premise+'" thoroughfare="'+tn+'" subbuilding="'+subbuilding+'" loc="'+loc+'" pc_sec="'+pc_sec+'" pc="'+n+'" aarea="'+aarea+'" simpleaddr="'+simpleaddr+'" deliver="'+deliver+'">'+a+"</option>"),l++)),"object"==typeof t[i]&&e(t[i]);return o(r).join("")}function o(t){var e={};return t.filter(function(t){return e.hasOwnProperty(t)?!1:e[t]=!0})}var r=new Array,a=new Array,l=1;a.push('<select style="width: '+n+'px;" size="10">');var h=JSON.stringify(t),u=z.parseJSON(h),c=JSON.stringify(u.Results),d=z.parseJSON(c),p=e(d);a.push(p),a.push("</select>");var f=a.join("");z("#showStreetResults").html(""),z("#showStreetResults").val(""),z("#showStreetResults").html(f),z("#showStreetResults").show(),r=[]}})}}),z("#PostalCodeSuggestions").autocomplete({showHeader:!0,minLength:1,delay:250,source:function(t,e){z.ajax({url:_,dataType:"jsonp",data:{maxrecords:s,postalcode:z("#PostalCodeSuggestions").val(),country:z("#showCountryResults").find(":selected").val(),id:r,format:"jsonp",nativecharset:!1},success:function(t){function e(t){var n="",a="",h="",u=z("#showCountryResults").find(":selected").val();for(i in t)n=t.PostalCode,a=t.Locality,h=t.AdministrativeArea,premise=t.Premise,null!=u.match(/(GB|UK)/gi)&&(n=t.PostalCodePrimary),console.log("POSTALCOOOODEEE: "+n+" locality: "+a+"country: "+u),"undefined"!=typeof n&&"string"==typeof n.valueOf()&&n.length>0&&"undefined"!=typeof a&&"string"==typeof a.valueOf()&&a.length>0&&(l>=0?(r.push('<option selected value="'+a+'" premise="'+premise+'" pc="'+n+'" aarea="'+h+'">'+n+", "+a+"</option>"),l++):l>=1&&s>=l&&(r.push('<option value="'+a+'" premise="'+premise+'" pc="'+n+'" aarea="'+h+'">'+n+", "+a+"</option>"),l++)),"object"==typeof t[i]&&e(t[i]);return o(r).join("")}function o(t){var e={};return t.filter(function(t){return e.hasOwnProperty(t)?!1:e[t]=!0})}var r=new Array,a=new Array,l=1;a.push('<select style="width: '+n+'px;" size="10">');var h=JSON.stringify(t),u=z.parseJSON(h),c=JSON.stringify(u.Results),d=z.parseJSON(c),p=e(d);a.push(p),a.push("</select>");var f=a.join("");z("#showPostalCodeResults").html(""),z("#showPostalCodeResults").val(""),z("#showPostalCodeResults").html(f),z("#showPostalCodeResults").show(),r=[]}})}}),z("#CountrySuggestions").autocomplete({showHeader:!0,minLength:1,delay:250,source:function(t,e){z.ajax({url:w,dataType:"jsonp",data:{country:z("#CountrySuggestions").val(),id:r,maxrecords:s,format:"jsonp"},success:function(t){function e(t){var n="",a="";for(i in t)n=t.Char2ISO,a=t.English,"undefined"!=typeof n&&"string"==typeof n.valueOf()&&n.length>0&&"undefined"!=typeof a&&"string"==typeof a.valueOf()&&a.length>0&&(l>=0?(r.push('<option selected value="'+n+'">'+a+"</option>"),l++):l>=1&&s>=l&&(r.push('<option value="'+n+'">'+a+"</option>"),l++)),"object"==typeof t[i]&&e(t[i]);return o(r).join("")}function o(t){var e={};return t.filter(function(t){return e.hasOwnProperty(t)?!1:e[t]=!0})}var r=new Array,a=new Array,l=1;a.push('<select style="width: '+n+'px;" size="10">');var h=JSON.stringify(t),u=z.parseJSON(h),c=JSON.stringify(u.Results),d=z.parseJSON(c),p=e(d);a.push(p),a.push("</select>");var f=a.join("");z("#showCountryResults").html(""),z("#showCountryResults").val(""),z("#showCountryResults").html(f),z("#showCountryResults").show(),r=[]}})}}),z("#CountrySuggestionsSingleRow").autocomplete({showHeader:!0,minLength:1,delay:250,source:function(t,e){z.ajax({url:w,dataType:"jsonp",data:{country:z("#CountrySuggestionsSingleRow").val(),id:r,maxrecords:s,format:"jsonp"},success:function(t){function e(t){var n="",a="";for(i in t)n=t.Char2ISO,a=t.English,"undefined"!=typeof n&&"string"==typeof n.valueOf()&&n.length>0&&"undefined"!=typeof a&&"string"==typeof a.valueOf()&&a.length>0&&(l>=0?(r.push('<option selected value="'+n+'">'+a+"</option>"),l++):l>=1&&s>=l&&(r.push('<option value="'+n+'">'+a+"</option>"),l++)),"object"==typeof t[i]&&e(t[i]);return o(r).join("")}function o(t){var e={};return t.filter(function(t){return e.hasOwnProperty(t)?!1:e[t]=!0})}var r=new Array,a=new Array,l=1;a.push('<select style="width: '+n+'px;" size="10">');var h=JSON.stringify(t),u=z.parseJSON(h),c=JSON.stringify(u.Results),d=z.parseJSON(c),p=e(d);a.push(p),a.push("</select>");var f=a.join("");z("#showCountryResultsSingleRow").html(""),z("#showCountryResultsSingleRow").val(""),z("#showCountryResultsSingleRow").html(f),z("#showCountryResultsSingleRow").show(),r=[]}})}})),z("#submitCheck").click(function(){e(),t()}),z("#billing-buttons-container .button").click(function(){var t=z("#billing\\:city").val(),e=z("#billing\\:postcode").val(),i=z("#billing\\:street1").val(),s=z("#billing\\:country_id").val(),n=(z("#billing\\:firstname").val(),z("#billing\\:lastname").val(),z("#billing\\:email").val()),o=n.includes("@"),r=n.includes(".");t.length>=2&&e.length>=2&&i.length>=2&&s.length>=1&&n.length>=6&&o===!0&&r===!0&&(z("#autocomplete_melissadata_fielded").hide(),z("#autocomplete_melissadata_singlerow").hide(),z("#autocomplete_melissadata_fielded").css("display","none"),z("#autocomplete_melissadata_singlerow").css("display","none"),z("#singleShow").hide(),z("#singleShow").css("display","none"),z("#multiShow").hide(),z("#multiShow").css("display","none"),z("#gawsresults_top").hide(),z("#gawsresults_top").css("display","none"),z("#submitCheck").hide(),z("#submitCheck").css("display","none"))})});
