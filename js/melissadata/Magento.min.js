...
content:function(){var e=t(this).attr("title")||"";return t("<a>").text(e).html()},hide:!0,items:"[title]:not([disabled])",position:{my:"left top+15",at:"left bottom",collision:"flipfit flip"},show:!0,tooltipClass:null,track:!1,close:null,open:null},_addDescribedBy:function(e,i){var s=(e.attr("aria-describedby")||"").split(/\s+/);s.push(i),e.data("ui-tooltip-id",i).attr("aria-describedby",t.trim(s.join(" ")))},_removeDescribedBy:function(e){var i=e.data("ui-tooltip-id"),s=(e.attr("aria-describedby")||"").split(/\s+/),n=t.inArray(i,s);-1!==n&&s.splice(n,1),e.removeData("ui-tooltip-id"),s=t.trim(s.join(" ")),s?e.attr("aria-describedby",s):e.removeAttr("aria-describedby")},_create:function(){this._on({mouseover:"open",focusin:"open"}),this.tooltips={},this.parents={},this.options.disabled&&this._disable(),this.liveRegion=t("<div>").attr({role:"log","aria-live":"assertive","aria-relevant":"additions"}).addClass("ui-helper-hidden-accessible").appendTo(this.document[0].body)},_setOption:function(e,i){var s=this;return"disabled"===e?(this[i?"_disable":"_enable"](),void(this.options[e]=i)):(this._super(e,i),void("content"===e&&t.each(this.tooltips,function(t,e){s._updateContent(e.element)})))},_disable:function(){var e=this;t.each(this.tooltips,function(i,s){var n=t.Event("blur");n.target=n.currentTarget=s.element[0],e.close(n,!0)}),this.element.find(this.options.items).addBack().each(function(){var e=t(this);e.is("[title]")&&e.data("ui-tooltip-title",e.attr("title")).removeAttr("title")})},_enable:function(){this.element.find(this.options.items).addBack().each(function(){var e=t(this);e.data("ui-tooltip-title")&&e.attr("title",e.data("ui-tooltip-title"))})},open:function(e){var i=this,s=t(e?e.target:this.element).closest(this.options.items);s.length&&!s.data("ui-tooltip-id")&&(s.attr("title")&&s.data("ui-tooltip-title",s.attr("title")),s.data("ui-tooltip-open",!0),e&&"mouseover"===e.type&&s.parents().each(function(){var e,s=t(this);s.data("ui-tooltip-open")&&(e=t.Event("blur"),e.target=e.currentTarget=this,i.close(e,!0)),s.attr("title")&&(s.uniqueId(),i.parents[this.id]={element:this,title:s.attr("title")},s.attr("title",""))}),this._registerCloseHandlers(e,s),this._updateContent(s,e))},_updateContent:function(t,e){var i,s=this.options.content,n=this,o=e?e.type:null;return"string"==typeof s?this._open(e,t,s):(i=s.call(t[0],function(i){n._delay(function(){t.data("ui-tooltip-open")&&(e&&(e.type=o),this._open(e,t,i))})}),void(i&&this._open(e,t,i)))},_open:function(e,i,s){function n(t){h.of=t,r.is(":hidden")||r.position(h)}var o,r,a,l,h=t.extend({},this.options.position);if(s){if(o=this._find(i))return void o.tooltip.find(".ui-tooltip-content").html(s);i.is("[title]")&&(e&&"mouseover"===e.type?i.attr("title",""):i.removeAttr("title")),o=this._tooltip(i),r=o.tooltip,this._addDescribedBy(i,r.attr("id")),r.find(".ui-tooltip-content").html(s),this.liveRegion.children().hide(),s.clone?(l=s.clone(),l.removeAttr("id").find("[id]").removeAttr("id")):l=s,t("<div>").html(l).appendTo(this.liveRegion),this.options.track&&e&&/^mouse/.test(e.type)?(this._on(this.document,{mousemove:n}),n(e)):r.position(t.extend({of:i},this.options.position)),r.hide(),this._show(r,this.options.show),this.options.show&&this.options.show.delay&&(a=this.delayedShow=setInterval(function(){r.is(":visible")&&(n(h.of),clearInterval(a))},t.fx.interval)),this._trigger("open",e,{tooltip:r})}},_registerCloseHandlers:function(e,i){var s={keyup:function(e){if(e.keyCode===t.ui.keyCode.ESCAPE){var s=t.Event(e);s.currentTarget=i[0],this.close(s,!0)}}};i[0]!==this.element[0]&&(s.remove=function(){this._removeTooltip(this._find(i).tooltip)}),e&&"mouseover"!==e.type||(s.mouseleave="close"),e&&"focusin"!==e.type||(s.focusout="close"),this._on(!0,i,s)},close:function(e){var i,s=this,n=t(e?e.currentTarget:this.element),o=this._find(n);return o?(i=o.tooltip,void(o.closing||(clearInterval(this.delayedShow),n.data("ui-tooltip-title")&&!n.attr("title")&&n.attr("title",n.data("ui-tooltip-title")),this._removeDescribedBy(n),o.hiding=!0,i.stop(!0),this._hide(i,this.options.hide,function(){s._removeTooltip(t(this))}),n.removeData("ui-tooltip-open"),this._off(n,"mouseleave focusout keyup"),n[0]!==this.element[0]&&this._off(n,"remove"),this._off(this.document,"mousemove"),e&&"mouseleave"===e.type&&t.each(this.parents,function(e,i){t(i.element).attr("title",i.title),delete s.parents[e]}),o.closing=!0,this._trigger("close",e,{tooltip:i}),o.hiding||(o.closing=!1)))):void n.removeData("ui-tooltip-open")},_tooltip:function(e){var i=t("<div>").attr("role","tooltip").addClass("ui-tooltip ui-widget ui-corner-all ui-widget-content "+(this.options.tooltipClass||"")),s=i.uniqueId().attr("id");return t("<div>").addClass("ui-tooltip-content").appendTo(i),i.appendTo(this.document[0].body),this.tooltips[s]={element:e,tooltip:i}},_find:function(t){var e=t.data("ui-tooltip-id");return e?this.tooltips[e]:null},_removeTooltip:function(t){t.remove(),delete this.tooltips[t.attr("id")]},_destroy:function(){var e=this;t.each(this.tooltips,function(i,s){var n=t.Event("blur"),o=s.element;n.target=n.currentTarget=o[0],e.close(n,!0),t("#"+i).remove(),o.data("ui-tooltip-title")&&(o.attr("title")||o.attr("title",o.data("ui-tooltip-title")),o.removeData("ui-tooltip-title"))}),this.liveRegion.remove()}})}),!function(t){if("function"==typeof define&&define.amd)define(t);else if("object"==typeof exports)module.exports=t();else{var e=window.Cookies,i=window.Cookies=t();i.noConflict=function(){return window.Cookies=e,i}}}(function(){function t(){for(var t=0,e={};t<arguments.length;t++){var i=arguments[t];for(var s in i)e[s]=i[s]}return e}function e(i){function s(e,n,o){var r;if("undefined"!=typeof document){if(arguments.length>1){if(o=t({path:"/"},s.defaults,o),"number"==typeof o.expires){var a=new Date;a.setMilliseconds(a.getMilliseconds()+864e5*o.expires),o.expires=a}try{r=JSON.stringify(n),/^[\{\[]/.test(r)&&(n=r)}catch(l){}return n=i.write?i.write(n,e):encodeURIComponent(String(n)).replace(/%(23|24|26|2B|3A|3C|3E|3D|2F|3F|40|5B|5D|5E|60|7B|7D|7C)/g,decodeURIComponent),e=encodeURIComponent(String(e)),e=e.replace(/%(23|24|26|2B|5E|60|7C)/g,decodeURIComponent),e=e.replace(/[\(\)]/g,escape),document.cookie=[e,"=",n,o.expires&&"; expires="+o.expires.toUTCString(),o.path&&"; path="+o.path,o.domain&&"; domain="+o.domain,o.secure?"; secure":""].join("")}e||(r={});for(var h=document.cookie?document.cookie.split("; "):[],u=/(%[0-9A-Z]{2})+/g,c=0;c<h.length;c++){var d=h[c].split("="),p=d[0].replace(u,decodeURIComponent),f=d.slice(1).join("=");'"'===f.charAt(0)&&(f=f.slice(1,-1));try{if(f=i.read?i.read(f,p):i(f,p)||f.replace(u,decodeURIComponent),this.json)try{f=JSON.parse(f)}catch(l){}if(e===p){r=f;break}e||(r[p]=f)}catch(l){}}return r}}return s.set=s,s.get=function(t){return s(t)},s.getJSON=function(){return s.apply({json:!0},[].slice.call(arguments))},s.defaults={},s.remove=function(e,i){s(e,"",t(i,{expires:-1}))},s.withConverter=e,s}return e(function(){})});var z=jQuery.noConflict(!0);z(document).ready(function(){function t(){if(y===!0){var t="",e=z("#billing\\:city").val(),i=z("#billing\\:postcode").val(),n=z("#billing\\:street1").val(),o=z("#billing\\:street2").val(),r=z("#billing\\:country_id").val(),a=z("#billing\\:region_id").val();e=z.trim(e),i=z.trim(i),n=z.trim(n),o=z.trim(o),r=z.trim(r),a=z.trim(a);s(e)+s(i)+s(n)+s(o)+s(r),Cookies.get("MelissaDataMagento_GAWS_AddressHash"),Math.random();return e.length>=2&&i.length>=2&&n.length>=2&&r.length>=1?(z.ajax({type:"GET",url:S,dataType:"jsonp",async:!0,cache:!1,data:{id:l,t:"Melissa Data Magento Plugin - Address Check (SE)",format:"json",ctry:r,a1:n,postal:i,loc:e},success:function(e){var i=JSON.stringify(e),s=z.parseJSON(i),n=JSON.stringify(s.Records),o=z.parseJSON(n),r=o[0].Results,a=(r.split(","),o[0].FormattedAddress),l=(o[0].Latitude,o[0].Longitude,o[0].Locality),h=o[0].PostalCode,u=o[0].AddressLine1,c=o[0].AddressLine2,d=(o[0].AddressLine3,o[0].AddressLine4,o[0].AddressLine5,o[0].Thoroughfare,o[0].CountryName,o[0].AdministrativeArea,o[0].SubNationalArea,o[0].CountryISO3166_1_Alpha3,o[0].CountryISO3166_1_Alpha2);o[0].PremisesNumber;return null!=r.match(/(AE..)/gi)?(t='Address: <span style="text-decoration: underline;">'+a+"</span> is not postal deliverable! <br />Please change your input address (Street, Premise, Suite, Locality, Postalcode)!",html_result_gaws='<span style="color: red; font-weight:bold;">'+t+"</span>"):null!=r.match(/(AV1|AE05|AV21|AV22)/gi)?(t='Address: <span style="text-decoration: underline;">'+a+"</span> has some errors in it! <br />Please consider checking your input (Street, Premise, Suite, Locality, Postalcode)!",html_result_gaws='<span style="color: orange; font-weight:bold;">'+t+"</span>"):null!=r.match(/(AV23|AV24|AV25)/gi)&&(t='Address: <span style="text-decoration: underline;">'+a+"</span> is fully postal deliverable! <br /> You are great!",html_result_gaws='<span style="color: green; font-weight:bold;">'+t+"</span>",z("#billing\\:country_id").val(d),z("#billing\\:street1").val(u),z("#billing\\:postcode").val(h),z("#billing\\:city").val(l),null!=d.match(/(GB|UK|US|AU|NL)/gi)&&z("#billing\\:street2").val(c)),z("#gawsresults_top").html(""),z("#gawsresults_top").html(html_result_gaws),z("#gawsresults_top").css("display","block"),1}}),0):0}}function e(){if(_===!0){var t="",e=z("#billing\\:email").val();e=z.trim(e);var i=(s(e),Cookies.get("MelissaDataMagento_EMAIL_DataHash"),e.includes("@")),n=e.includes(".");Math.random();return e.length>=6&&i===!0&&n===!0?(z.ajax({type:"GET",url:T,dataType:"jsonp",async:!0,cache:!1,data:{id:h,t:"Melissa Data Magento Plugin - Email Check (SE)",opt:"VERIFYMAILBOX:Express,DomainCorrection:On",format:"json",email:e},success:function(e){var i=JSON.stringify(e),s=z.parseJSON(i),n=JSON.stringify(s.Records),o=z.parseJSON(n),r=o[0].Results,a=r.split(","),l=o[0].EmailAddress,h=(o[0].MailboxName,o[0].DomainName,o[0].TopLevelDomain,o[0].TopLevelDomainName,""),u=0;z.each(a,function(t,e){e=e.trim(),null!=e.match(/ES01/gi)&&u++,null!=e.match(/ES20/gi)&&u++});var c=0;return null!=r.match(/(EE01|EE02|EE03|EE04|ES02|ES03|ES04|ES05|ES06|ES09)/gi)?(t='eMail: <span style="text-decoration: underline;">'+l+"</span> is not deliverable! <br />Please change your input Email address!",h=' <span style="color: red; font-weight:bold;">'+t+"</span>",c=0):null!=r.match(/(ES07|ES08)/gi)||2==u?(t='eMail: <span style="text-decoration: underline;">'+l+"</span> might be a correct written Email, a Catch-All or Group Email Address! <br />Please change your input Email address!",h=' <span style="color: orange; font-weight:bold;">'+t+"</span>",c=0):null!=r.match(/(ES01|ES20|ES21|ES22)/gi)&&2!=u&&(t='eMail: <span style="text-decoration: underline;">'+l+"</span> is fully deliverable! <br /> Thats fantastic!",h=' <span style="color: green; font-weight:bold;">'+t+"</span>",c=1),z("#gawsresults_top").append(h),z("#gawsresults_top").css("display","block"),c}}),-1):0}}function s(t){var e=0;if(0==t.length)return e;for(i=0;i<t.length;i++)char=t.charCodeAt(i),e=(e<<5)-e+char,e&=e;return e}var n=25,o=225,r=450,a=Cookies.get("MelissaDataMagento_GEE_Token"),l=Cookies.get("MelissaDataMagento_GAWS_Token"),h=Cookies.get("MelissaDataMagento_EMAIL_Token"),u=Cookies.get("MelissaDataMagento_EMAIL_ENABLED"),c=Cookies.get("MelissaDataMagento_GAWS_ENABLED"),d=Cookies.get("MelissaDataMagento_GEE_ENABLED"),p=Cookies.get("MelissaDataMagento_GEE_SINGLEROWCOUNTRIES"),f=Cookies.get("MelissaDataMagento_GEE_SINGLEROW_ENABLED"),g=Cookies.get("MelissaDataMagento_GEE_MULTIROW_ENABLED"),m=f.includes("1"),v=g.includes("1"),b=d.includes("1"),y=c.includes("1"),_=u.includes("1"),w=p.split(","),x="https://expressentry.melissadata.net/jsonp/GlobalExpressPostalCode",C="https://expressentry.melissadata.net/jsonp/GlobalExpressCountry",x="https://expressentry.melissadata.net/jsonp/GlobalExpressPostalCode",k="https://expressentry.melissadata.net/jsonp/GlobalExpressAddress",D="https://expressentry.melissadata.net/jsonp/GlobalExpressFreeForm",S="https://address.melissadata.net/V3/WEB/GlobalAddress/doGlobalAddress",T="https://globalemail.melissadata.net/v3/WEB/GlobalEmail/doGlobalEmail",I='<br /><p><table id="autocomplete_melissadata_singlerow" border="0px;"><tr style="font-weight: bold; font-size: 140%;"><b id="singleShow">Melissa Data Single Row Autocompletion Support:</b></tr><tr width="" style="clear:both;"><td><br /></td></tr><tr style="clear:both;"><td width="'+o+'px"><input type="text" value="" placeholder="1. Step: Type Country Name" title="Start typing a country name to get Suggestions" id="CountrySuggestionsSingleRow" style="width: '+o+'px;" /><span id="showCountryResultsSingleRow" style="height:75px;line-height:3em;overflow:auto;padding:5px;"></span></td><td width="'+r+'px"><input type="text" value="" placeholder="2. Step: Type House Number and Street Name" title="Start typing a Postal code & Address to get Suggestions from within that Country" id="AddressSuggestionsSingleRow" style="width: '+r+'px;" /><span id="showAddressResultsSingleRow" style="width: '+r+'px; height:75px;line-height:3em;overflow:auto;padding:5px;"></span></td></tr></table></p><br /><br />',P='<br /><p><table id="autocomplete_melissadata_fielded" border="0px;"><tr style="font-weight: bold; font-size: 140%;"><b id="multiShow">Melissa Data Fielded Autocompletion Support:</b></tr><tr width="'+3*o+'px"><td><br /></td></tr><tr style="clear:both;"><td width="'+o+'px"><input type="text" value="" placeholder="1. Step: Type Country Name" title="Start typing a country name to get Suggestions" id="CountrySuggestions" style="width: '+o+'px;" /><span id="showCountryResults" style="width:150px;height:75px;line-height:3em;overflow:auto;padding:5px;"></span></td><td width="'+o+'px"><input type="text" value="" placeholder="2. Step: Type Postal Code" title="Start typing a Postal code to get Suggestions from within that Country" id="PostalCodeSuggestions" style="width: '+o+'px;" /><span id="showPostalCodeResults" style="width:150px;height:75px;line-height:3em;overflow:auto;padding:5px;"></span></td><td width="'+o+'px"><input type="text" value="" placeholder="3. Step: Type House Number and Street Name" title="Start typing a street name to get suggestions for them within that Postal code range in that country" id="StreetSuggestions" style="width: '+o+'px;" /><span id="showStreetResults" style="height:75px;line-height:3em;overflow:auto;padding:5px;"></span></td></tr></table></p><br /><br /><p>';if(b===!0&&(z("#checkout-step-billing").css("display","inline"),z("#billing\\:region_id").css("display","inline"),z(I).insertBefore("#checkout-step-billing"),z(P).insertBefore("#checkout-step-billing"),z("#autocomplete_melissadata_fielded").hide(),z("#autocomplete_melissadata_singlerow").hide(),z("#autocomplete_melissadata_fielded").css("display","none"),z("#autocomplete_melissadata_singlerow").css("display","none"),z("#singleShow").hide(),z("#singleShow").css("display","none"),z("#multiShow").hide(),z("#multiShow").css("display","none"),m===!0?(z("#singleShow").show(),z("#singleShow").css("display","inline"),z("#autocomplete_melissadata_singlerow").show(),z("#autocomplete_melissadata_singlerow").css("display","inline")):v===!0?(z("#multiShow").show(),z("#multiShow").css("display","inline"),z("#autocomplete_melissadata_fielded").show(),z("#autocomplete_melissadata_fielded").css("display","inline")):(z("#autocomplete_melissadata_singlerow").hide(),z("#autocomplete_melissadata_singlerow").css("display","none"),z("#autocomplete_melissadata_fielded").hide(),z("#autocomplete_melissadata_fielded").css("display","none"))),y===!0&&_===!0){var A='<form id="formaction"><input type="button" id="submitCheck" title="Verify now the Input Address Values" value=" Verify Now "></form><br /><span id="gawsresults_top" style="display:none;"></span><br /><span id="errorresults_top" style="display:none;"></span>';z(A).insertBefore("#checkout-step-billing"),z("#checkout-step-billing").css("display","inline"),z("#billing\\:region_id").css("display","inline")}else if(y===!0){var A='<form><input type="button" id="submitCheck" title="Verify now the Input Address Values" value=" Verify Now "></form><br /><span id="gawsresults_top" style="display:none;"></span><br /><span id="errorresults_top" style="display:none;"></span>';z(A).insertBefore("#checkout-step-billing"),z("#checkout-step-billing").css("display","inline"),z("#billing\\:region_id").css("display","inline")}else if(_===!0){var M='<form><input type="button" id="submitCheck" title="Verify now the Input Address Values" value=" Verify Now "></form><br /><span id="gawsresults_top" style="display:none;"></span><br /><span id="errorresults_top" style="display:none;"></span>';z(M).insertBefore("#checkout-step-billing"),z("#checkout-step-billing").css("display","inline"),z("#billing\\:region_id").css("display","inline")}z("#showCountryResults").on("click",function(){var t=z("#showCountryResults").find(":selected").val(),e=z("#showCountryResults").find(":selected").text(),i='<option selected value="'+t+'">'+e+"</option>",s=new Array;s.push('<select style="width: '+o+'px;" size="10">'),s.push(i),s.push("</select>");var n=s.join(""),r=0;z.each(w,function(e,i){i=i.trim();var s=t.toLowerCase();-1!=i.toLowerCase().indexOf(s)&&(r=1)}),1==r?(z("#billing\\:country_id").html(i),z("#autocomplete_melissadata_singlerow").show(),z("#autocomplete_melissadata_fielded").hide(),z("#CountrySuggestionsSingleRow").val(""),z("#CountrySuggestionsSingleRow").html(""),z("#CountrySuggestionsSingleRow").val(e),z("#showAddressResultsSingleRow").html(""),z("#showAddressResultsSingleRow").val(""),z("#AddressSuggestionsSingleRow").html(""),z("#AddressSuggestionsSingleRow").val(""),z("#AddressSuggestionsSingleRow").focus(),z("#showAddressResultsSingleRow").focus(),z("#AddressResultsSingleRow").focus(),z("#showCountryResultsSingleRow").hide(),z("#showCountryResultsSingleRow").html(n)):(z("#billing\\:country_id").html(i),z("#CountrySuggestions").val(""),z("#CountrySuggestions").html(""),z("#CountrySuggestions").val(e),z("#PostalCodeSuggestions").val(""),z("#showPostalCodeResults").val(""),z("#PostalCodeSuggestions").html(""),z("#showPostalCodeResults").html(""),z("#billing\\:street1").val(""),z("#showStreetResults").val(""),z("#showStreetResults").html(""),z("#StreetSuggestions").val(""),z("#StreetSuggestions").html(""),z("#PostalCodeSuggestions").focus(),z("#showPostalCodeResults").focus(),z("#showCountryResults").html(n),z("#showCountryResults").hide()),res="Country has been chosen.",html_result_gaws='<span style="color: green; font-weight:bold;">'+res+"</span>",z("#gawsresults_top").html(html_result_gaws),z("#gawsresults_top").css("display","block")}),z("#showPostalCodeResults").on("click",function(){var t=z("#showPostalCodeResults").find(":selected").val(),e=z("#showPostalCodeResults").find(":selected").attr("pc"),i=z("#showCountryResults").find(":selected").val(),s=z("#showCountryResults").find(":selected").text(),n='<option selected value="'+i+'">'+s+"</option>";z("#PostalCodeSuggestions").val(""),z("#PostalCodeSuggestions").html(""),z("#PostalCodeSuggestions").val(e+", "+t),z(".field .input-box #billing\\:country_id").html(n),z(".field .input-box #billing\\:city").val(t),z(".field .input-box #billing\\:postcode").val(e),z("#billing\\:street1").val(""),z("#showStreetResults").val(""),z("#showStreetResults").html(""),z("#StreetSuggestions").val(""),z("#StreetSuggestions").html(""),z("#showStreetResults").focus(),z("#StreetSuggestions").focus(),z("#showPostalCodeResults").hide(),res="Postal Code has been chosen.",html_result_gaws='<span style="color: green; font-weight:bold;">'+res+"</span>",z("#gawsresults_top").html(html_result_gaws),z("#gawsresults_top").css("display","block")}),z("#showCountryResultsSingleRow").on("click",function(){var t=(z("#showCountryResultsSingleRow").find(":selected").val(),z("#showCountryResultsSingleRow").find(":selected").text());z("#CountrySuggestionsSingleRow").val(""),z("#CountrySuggestionsSingleRow").html(""),z("#CountrySuggestionsSingleRow").val(t),z("#showAddressResultsSingleRow").html(""),z("#showAddressResultsSingleRow").val(""),z("#AddressSuggestionsSingleRow").html(""),z("#AddressSuggestionsSingleRow").val(""),z("#AddressSuggestionsSingleRow").focus(),z("#showAddressResultsSingleRow").focus(),z("#AddressResultsSingleRow").focus(),z("#showCountryResultsSingleRow").hide(),res="Country has been chosen.",html_result_gaws='<span style="color: green; font-weight:bold;">'+res+"</span>",z("#gawsresults_top").html(html_result_gaws),z("#gawsresults_top").css("display","block")}),z("#showStreetResults").on("click",function(){var t=z("#showPostalCodeResults").find(":selected").val(),e=z("#showPostalCodeResults").find(":selected").attr("pc"),i=z("#showStreetResults").find(":selected").text(),s=z("#showPostalCodeResults").find(":selected").attr("aarea"),n=z("#showStreetResults").find(":selected").attr("aarea"),o=z("#showCountryResults").find(":selected").val(),r=z("#showCountryResults").find(":selected").text(),a='<option selected value="'+o+'">'+r+"</option>",l='<option selected value="'+s+'">'+n+"</option>";z(".field .input-box #billing\\:city").val(t),z(".field .input-box #billing\\:postcode").val(e),z("#billing\\:street1").val(i),z(".field .input-box #billing\\:country_id").html(a),z(".field .input-box #billing\\:region_id").html(l),z("#StreetSuggestions").val(""),z("#StreetSuggestions").html(""),z("#StreetSuggestions").val(i),z("#showStreetResults").hide(),res="Street & House Number have been chosen.",html_result_gaws='<span style="color: green; font-weight:bold;">'+res+"</span>",z("#gawsresults_top").html(html_result_gaws),z("#gawsresults_top").css("display","block")}),z("#showAddressResultsSingleRow").on("click",function(){var t=z("#showAddressResultsSingleRow").find(":selected").attr("loc"),e=z("#showAddressResultsSingleRow").find(":selected").attr("pc"),i=z("#showAddressResultsSingleRow").find(":selected").attr("deliver"),s=z("#showAddressResultsSingleRow").find(":selected").attr("aarea"),n=(z("#showAddressResultsSingleRow").find(":selected").attr("simpleaddr"),z("#showAddressResultsSingleRow").find(":selected").val()),o=z("#showCountryResultsSingleRow").find(":selected").val(),r=z("#showCountryResultsSingleRow").find(":selected").text(),a='<option selected value="'+o+'">'+r+"</option>",l='<option selected value="'+s+'">'+s+"</option>";z(".field .input-box #billing\\:city").val(t),z(".field .input-box #billing\\:postcode").val(e),z("#billing\\:street1").val(i),z("#billing\\:street2").val(),z(".field .input-box #billing\\:country_id").html(a),z(".field .input-box #billing\\:region_id").html(l),z("#AddressSuggestionsSingleRow").val(""),z("#AddressSuggestionsSingleRow").html(""),z("#AddressSuggestionsSingleRow").val(n),z("#showAddressResultsSingleRow").hide(),res="Street and House Number have been chosen.",html_result_gaws='<span style="color: green; font-weight:bold;">'+res+"</span>",z("#gawsresults_top").html(html_result_gaws),z("#gawsresults_top").css("display","block")}),b===!0&&(z("#AddressSuggestionsSingleRow").autocomplete({showHeader:!0,minLength:1,delay:250,source:function(t,e){z.ajax({url:D,dataType:"jsonp",data:{maxrecords:n,ff:z("#AddressSuggestionsSingleRow").val(),country:z("#showCountryResultsSingleRow").find(":selected").val(),id:a,format:"jsonp",nativecharset:!1},success:function(t){function e(t){var r="",a="";for(i in t){z("#showCountryResultsSingleRow").find(":selected").val();a=t.Address,simpleaddr=t.Address2,loc=t.Locality,r=t.PostalCode,aarea=t.AdministrativeArea,deliver=t.DeliveryAddress,"undefined"!=typeof a&&"string"==typeof a.valueOf()&&a.length>0&&(l>=0?(o.push('<option selected value="'+a+'" loc="'+loc+'" pc="'+r+'" aarea="'+aarea+'" simpleaddr="'+simpleaddr+'" deliver="'+deliver+'">'+a+"</option>"),l++):l>=2&&n>=l&&(o.push('<option value="'+a+'" loc="'+loc+'" pc="'+r+'" aarea="'+aarea+'" simpleaddr="'+simpleaddr+'" deliver="'+deliver+'">'+a+"</option>"),l++)),"object"==typeof t[i]&&e(t[i])}return s(o).join("")}function s(t){var e={};return t.filter(function(t){return e.hasOwnProperty(t)?!1:e[t]=!0})}var o=new Array,a=new Array,l=1,h=r+100;a.push('<select style="width: '+h+'px;" size="10">');var u=JSON.stringify(t),c=z.parseJSON(u),d=JSON.stringify(c.Results),p=z.parseJSON(d),f=e(p);a.push(f),a.push("</select>");var g=a.join("");z("#showAddressResultsSingleRow").html(""),z("#showAddressResultsSingleRow").val(""),z("#showAddressResultsSingleRow").html(g),z("#showAddressResultsSingleRow").show(),o=[]}})}}),z("#StreetSuggestions").autocomplete({showHeader:!0,minLength:1,delay:250,source:function(t,e){z.ajax({url:k,dataType:"jsonp",data:{maxrecords:n,address1:z("#StreetSuggestions").val(),locality:z("#showPostalCodeResults").find(":selected").val(),postalcode:z("#showPostalCodeResults").find(":selected").attr("pc"),country:z("#showCountryResults").find(":selected").val(),id:a,format:"jsonp",nativecharset:!1},success:function(t){function e(t){var o="";for(i in t)o=t.DeliveryAddress,aarea=t.AdministrativeArea,"undefined"!=typeof o&&"string"==typeof o.valueOf()&&o.length>0&&(l>=0?(r.push('<option selected value="'+o+'" aarea="'+aarea+'">'+o+"</option>"),l++):l>=2&&n>=l&&(r.push('<option value="'+o+'" aarea="'+aarea+'">'+o+"</option>"),l++)),"object"==typeof t[i]&&e(t[i]);return s(r).join("")}function s(t){var e={};return t.filter(function(t){return e.hasOwnProperty(t)?!1:e[t]=!0})}var r=new Array,a=new Array,l=1;a.push('<select style="width: '+o+'px;" size="10">');var h=JSON.stringify(t),u=z.parseJSON(h),c=JSON.stringify(u.Results),d=z.parseJSON(c),p=e(d);a.push(p),a.push("</select>");var f=a.join("");z("#showStreetResults").html(""),z("#showStreetResults").val(""),z("#showStreetResults").html(f),z("#showStreetResults").show(),r=[]}})}}),z("#PostalCodeSuggestions").autocomplete({showHeader:!0,minLength:1,delay:250,source:function(t,e){z.ajax({url:x,dataType:"jsonp",data:{maxrecords:n,postalcode:z("#PostalCodeSuggestions").val(),country:z("#showCountryResults").find(":selected").val(),id:a,format:"jsonp",nativecharset:!1},success:function(t){function e(t){var o="",a="",h="";for(i in t)o=t.PostalCodePrimary,a=t.Locality,h=t.AdministrativeArea,"undefined"!=typeof o&&"string"==typeof o.valueOf()&&o.length>0&&"undefined"!=typeof a&&"string"==typeof a.valueOf()&&a.length>0&&(l>=0?(r.push('<option selected value="'+a+'" pc="'+o+'" aarea="'+h+'">'+o+", "+a+"</option>"),l++):l>=2&&n>=l&&(r.push('<option value="'+a+'" pc="'+o+'" aarea="'+h+'">'+o+", "+a+"</option>"),l++)),"object"==typeof t[i]&&e(t[i]);return s(r).join("")}function s(t){var e={};return t.filter(function(t){return e.hasOwnProperty(t)?!1:e[t]=!0})}var r=new Array,a=new Array,l=1;a.push('<select style="width: '+o+'px;" size="10">');var h=JSON.stringify(t),u=z.parseJSON(h),c=JSON.stringify(u.Results),d=z.parseJSON(c),p=e(d);a.push(p),a.push("</select>");var f=a.join("");z("#showPostalCodeResults").html(""),z("#showPostalCodeResults").val(""),z("#showPostalCodeResults").html(f),z("#showPostalCodeResults").show(),r=[]}})}}),z("#CountrySuggestions").autocomplete({showHeader:!0,minLength:1,delay:250,source:function(t,e){z.ajax({url:C,dataType:"jsonp",data:{country:z("#CountrySuggestions").val(),id:a,maxrecords:n,format:"jsonp"},success:function(t){function e(t){var o="",a="";for(i in t)o=t.Char2ISO,a=t.English,"undefined"!=typeof o&&"string"==typeof o.valueOf()&&o.length>0&&"undefined"!=typeof a&&"string"==typeof a.valueOf()&&a.length>0&&(l>=0?(r.push('<option selected value="'+o+'">'+a+"</option>"),l++):l>=2&&n>=l&&(r.push('<option value="'+o+'">'+a+"</option>"),l++)),"object"==typeof t[i]&&e(t[i]);return s(r).join("")}function s(t){var e={};return t.filter(function(t){return e.hasOwnProperty(t)?!1:e[t]=!0})}var r=new Array,a=new Array,l=1;a.push('<select style="width: '+o+'px;" size="10">');var h=JSON.stringify(t),u=z.parseJSON(h),c=JSON.stringify(u.Results),d=z.parseJSON(c),p=e(d);a.push(p),a.push("</select>");var f=a.join("");z("#showCountryResults").html(""),z("#showCountryResults").val(""),z("#showCountryResults").html(f),z("#showCountryResults").show(),r=[]}})}}),z("#CountrySuggestionsSingleRow").autocomplete({showHeader:!0,minLength:1,delay:250,source:function(t,e){z.ajax({url:C,dataType:"jsonp",data:{country:z("#CountrySuggestionsSingleRow").val(),id:a,maxrecords:n,format:"jsonp"},success:function(t){function e(t){var o="",a="";for(i in t)o=t.Char2ISO,a=t.English,"undefined"!=typeof o&&"string"==typeof o.valueOf()&&o.length>0&&"undefined"!=typeof a&&"string"==typeof a.valueOf()&&a.length>0&&(l>=0?(r.push('<option selected value="'+o+'">'+a+"</option>"),l++):l>=2&&n>=l&&(r.push('<option value="'+o+'">'+a+"</option>"),l++)),"object"==typeof t[i]&&e(t[i]);return s(r).join("")}function s(t){var e={};return t.filter(function(t){return e.hasOwnProperty(t)?!1:e[t]=!0})}var r=new Array,a=new Array,l=1;a.push('<select style="width: '+o+'px;" size="10">');var h=JSON.stringify(t),u=z.parseJSON(h),c=JSON.stringify(u.Results),d=z.parseJSON(c),p=e(d);a.push(p),a.push("</select>");var f=a.join("");z("#showCountryResultsSingleRow").html(""),z("#showCountryResultsSingleRow").val(""),z("#showCountryResultsSingleRow").html(f),z("#showCountryResultsSingleRow").show(),r=[]}})}})),z("#submitCheck").click(function(){var i="eMail Check not possible - not all required Elements of an eMail given!",s="Address Verification not possible - not all needed Elements of Address Check are given!",n="",o=e(),r=t();-1==r||-1==o||1==r&&1==o||(1==r&&0==o?n=' <span style="color: orange; font-weight:bold;">'+i+"</span>":1==o&&0==r?n=' <span style="color: orange; font-weight:bold;">'+s+"</span>":0==r&&0==o?n='<span style="color: orange; font-weight:bold;">'+i+"<br />"+s+"</span>":0==r?n='<span style="color: orange; font-weight:bold;">'+s+"</span>":0==o&&(n='<span style="color: orange; font-weight:bold;">'+i+"</span>")),z("#errorresults_top").html(n),z("#errorresults_top").css("display","block"),z("#errorresults_top").fadeOut(6800)})});
